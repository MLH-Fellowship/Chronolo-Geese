...
function sortedChanges(query, events) {
    return collectionChanges(query, events).pipe(operators.scan(function (current, changes) { return processDocumentChanges(current, changes, events); }, []), operators.distinctUntilChanged());
}
/**
