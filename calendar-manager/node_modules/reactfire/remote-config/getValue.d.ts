...
declare type RemoteConfig = import('firebase/app').remoteConfig.RemoteConfig;
declare type RemoteConfigValue = import('firebase/app').remoteConfig.Value;
export declare type AllParameters = {
    [key: string]: RemoteConfigValue;
};
export declare function getValue(remoteConfig: RemoteConfig, key: string): Observable<import("firebase").remoteConfig.Value>;
