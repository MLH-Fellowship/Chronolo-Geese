...
}(U), V = /^[_a-zA-Z][_a-zA-Z0-9]*$/, C = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.o = function(t, e, r) {
 ...
 */ var pt = /** @class */ function(e) {
    ...
    return t(n, e), n.fromBase64String = function(t) {
        q("Blob.fromBase64String", arguments, 1), j("Blob.fromBase64String", "string", 1, t), 
        lt();
        try {
...
function At(t) {
    return M.F(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
...
var Lt = /** @class */ function() {
    ...
    t.prototype.Ct = function() {
        if (this.gt() && this.left.gt()) throw D();
        if (this.right.gt()) throw D();
        var t = this.left.Ct();
        if (t !== this.right.Ct()) throw D();
...
var jt = new Lt(M.i), zt = new Vt(M.i);
...
function de(t) {
    return function t(e) {
        ...
        M.C(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function Ce(t, e) {
    var n = Pe(e);
    return x(n.get(1) === t.U.projectId), x(!n.get(3) && !t.U.database || n.get(3) === t.U.database), 
    new M(Ge(n));
}
...
function Fe(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? P.g() : Ge(e);
}

function qe(t) {
    return new P([ "projects", t.U.projectId, "databases", t.U.database ]).R();
}

function Ge(t) {
    return x(t.length > 4 && "documents" === t.get(4)), t.u(5)
...
function ze(t, e) {
    ...
    if (e.transform) {
        var u = Ce(t, e.transform.document), a = e.transform.fieldTransforms.map((function(e) {
            return function(t, e) {
                var n = null;
                if ("setToServerValue" in e) x("REQUEST_TIME" === e.setToServerValue), n = new an; else if ("appendMissingElements" in e) {
                    var r = e.appendMissingElements.values || [];
                    n = new cn(r);
                } else if ("removeAllFromArray" in e) {
                    var i = e.removeAllFromArray.values || [];
                    n = new fn(i);
                } else "increment" in e ? n = new pn(t, e.increment) : D();
                var o = C.S(e.fieldPath);
                return new mn(o, n);
            }(t, e);
        }));
        return x(!0 === n.exists), new kn(u, a);
    }
    if (e.verify) {
        var c = Ce(t, e.verify);
        return new Un(c, n);
 ...
 */ function En(t, e, n) {
    return t instanceof Sn ? function(t, e, n) {
        ...
        if (x(null != n.transformResults), !bn(t.Ke, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */ function $n(t) {
    ...
    if (null === e.an) {
        ...
        n.p() || e.an.push(new wr(n)), e.an.push(new wr(C.v(), "asc" /* ASCENDING */)); else {
...
/** Returns whether `doc` matches the constraints of `query`. */ function ir(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.N(t.collectionGroup) && t.path.T(n) : M.F(t.path) ? t.path.isEqual(n) : t.path.I(n);
    }(t, e) && function(t, e) {
...
var ur = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = M.C(r.referenceValue), i;
    }
 ...
 */ function mr(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.p() ? M.i(M.C(s.referenceValue), n.key) : le(s, n.field(o.field)), 
...
function br(t, e, n) {
    var r = t.field.p() ? M.i(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? le(r, i) : D();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var Er = function() {
    ...
    t.prototype.Rn = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && T("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Tn + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Sn && D(), this.Sn = !0, this.vn ? this.error ? this.Dn(n, this.error) : this.Cn(e, this.result) : new t((function(t, i) {
            r.pn = function(n) {
                r.Cn(e, n).next(t, i);
            }, r.bn = function(e) {
                r.Dn(n, e).next(t, i);
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.Mn(u()) && N("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return T("SimpleDb", "Removing database:", t), Or(window.indexedDB.deleteDatabase(t)).Nn();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.On = function() {
        ...
        // Check the UA string to find out the browser.
                var e = u(), n = t.Mn(e), r = 0 < n && n < 10, i = t.Bn(e), o = 0 < i && i < 4.5;
        // IE 10
                  ...
                  case 0:
                    ...
                    t = this, [ 4 /*yield*/ , new Promise((function(t, n) {
                        ...
                        r.onsuccess = function(e) {
                            ...
                            "VersionError" === e.name ? n(new I(b.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Sr(e));
                        }, r.onupgradeneeded = function(t) {
                            T("SimpleDb", 'Database "' + e.name + '" requires upgrade from version:', t.oldVersion);
                            var n = t.target.result;
                            e.kn.createOrUpgrade(n, r.transaction, t.oldVersion, e.version).next((function() {
                                T("SimpleDb", "Database upgrade to version " + e.version + " complete");
                            }));
                        };
                    })) ]);
                    ...
                    e = "readonly" === t, o = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 4:
                                return c = n.sent(), h = "FirebaseError" !== c.name && o < 3, T("SimpleDb", "Transaction failed with error:", c.message, "Retrying:", h), 
 ...
 */ var xr = /** @class */ function() {
    ...
    return t.open = function(e, n, r) {
        ...
        t && this.Xn.reject(t), this.aborted || (T("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    t.prototype.add = function(t) {
        return T("SimpleDb", "ADD", this.store.name, t, t), Or(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return T("SimpleDb", "DELETE", this.store.name, t), Or(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return T("SimpleDb", "COUNT", this.store.name), Or(this.store.count());
 ...
 */ var Vr = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this._s && (this.clearTimeout(), this.hs.reject(new I(b.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.ys = function() {
            var e = Pr();
            e && T("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.gs.yn();
        };
        var e = Pr();
    ...
    t.prototype.Cs = function() {
        ...
        var e = this, n = this.ws.then((function() {
            return e.Rs = !0, t().catch((function(t) {
                ...
                throw e.As = t, e.Rs = !1, N("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
function Mr(t, e) {
    if (N("AsyncQueue", e + ": " + t), Dr(t)) return new I(b.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
function Gr(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                if (e = k(t), i = r.query, o = !1, (s = e.Ls.get(i)) || (o = !0, s = new Fr), !o) return [ 3 /*break*/ , 4 ];
                n.label = 1;
...
function Br(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o, s, u;
        return n(this, (function(n) {
            return e = k(t), i = r.query, o = !1, (s = e.Ls.get(i)) && (u = s.listeners.indexOf(r)) >= 0 && (s.listeners.splice(u, 1), 
...
var Jr = /** @class */ function() {
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.On = function(t) {
        ...
        // `Window.addEventListener`.
            ...
            if (T("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Ii) return void N("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this._n.Ds((function() {
    ...
    t.prototype.bi = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this._i.tr(t.batchId, t.state, t.error) ] : (T("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
 ...
 */
        ...
        return this.Dr(t, new M(e)).next((function(t) {
            var e = Bt();
...
var yi = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        T("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.mo = this.os.gn("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return e(r, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Dr(e = n.sent()) ? (T("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    t.prototype.po = function(t, e) {
        ...
        var n = this;
        return this.params.so === vi.uo ? (T("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Tr.resolve(di)) : this.vo(t).next((function(r) {
            return r < n.params.so ? (T("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.so), 
            di) : n.So(t, e);
        }));
        ...
        return this.Ao(t, this.params.io).next((function(e) {
            ...
            return e > h.params.ro ? (T("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + h.params.ro + " from " + e), 
 ...
 */ function Ii(t) {
    ...
    var e = t.length;
    if (x(e >= 2), 2 === e) return x("" === t.charAt(0) && "" === t.charAt(1)), P.g();
...
/** Decodes a remote document from storage locally to a Document. */ function _i(t, e) {
    ...
    if (e.noDocument) {
        var n = M.$(e.noDocument.path), r = Di(e.noDocument.readTime);
        return new qn(n, r, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        var i = M.$(e.unknownDocument.path), o = Di(e.unknownDocument.version);
        return new Gn(i, o);
    }
    return D();
}
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var Ri = /** @class */ function() {
    ...
    return t.Fo = function(e, n, r, i) {
        ...
        return x("" !== e.uid), new t(e.Xs() ? e.uid : "", n, r, i);
        ...
        return Pi(t).get(e).next((function(t) {
            return t ? (x(t.userId === n.userId), xi(n.serializer, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Oo = function(t, e) {
        ...
        return Pi(t).ss({
            ...
            e.userId === n.userId && (x(e.batchId >= r), o = xi(n.serializer, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        // the given documentKey.
            ...
            return Pi(t).get(c).next((function(t) {
                if (!t) throw D();
                x(t.userId === n.userId), o.push(xi(n.serializer, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        return e.forEach((function(e) {
            i.push(Pi(t).get(e).next((function(t) {
                if (null === t) throw D();
                x(t.userId === n.userId), r.push(xi(n.serializer, t));
            })));
        })), Tr.$n(i).next((function() {
            return r;
        }));
 ...
 */ var Mi = /** @class */ function() {
    ...
    t.prototype.ea = function(t, e) {
        ...
        return qi(t).ss({
            ...
            for (var s = M.$(t); o && M.i(o, s) < 0; ) n(o, null), o = i.Et();
            o && o.isEqual(s) && (
            // Key found in cache.
 ...
 */ Mi.ca = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.gr = function(t) {
        ...
        })), n.push(this.la.updateMetadata(t, r)), Tr.$n(n);
...
var ji = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t._(), n = t.h(), r = this.index[e] || new Vt(P.i), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t._(), n = t.h(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Vt(P.i)).A();
    }, t;
}(), Qi = /** @class */ function() {
    function t(t) {
        this.serializer = t;
...
var uo = r(r(r([ Yi.store, Hi.store, $i.store, Zi.store, eo.store, Wi.store, ro.store, no.store ], [ so.store ]), [ to.store ]), [ io.store ]), ao = /** @class */ function() {
    function t() {
        /**
 ...
 */ var ho = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Sa(t, e.targetId).next((function() {
            ...
            return x(e.targetCount > 0), e.targetCount -= 1, n.Aa(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.pa = function(t, e) {
        ...
        // IndexedDb.
            ...
            var o = gi(e.path);
            return Tr.$n([ i.delete([ n, o ]), r.Co.xa(t, n, e) ]);
        }));
 ...
 */ var yo = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", mo = /** @class */ function(e) {
    ...
    h) {
        ...
        }, !t.On()) throw new I(b.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    ...
    t.prototype.start = function() {
        ...
        // do.
            ...
            throw new I(b.FAILED_PRECONDITION, yo);
    ...
    t.prototype.Vi = function() {
        ...
        return this.za.runTransaction(o, uo, (function(o) {
            return i = new mo(o, r.Ba ? r.Ba.next() : Yr.oi), "readwrite-primary" === e ? r.ic(i).next((function(t) {
                ...
                r._n.Ds((function() {
                    return r.Ka(!1);
                })), new I(b.FAILED_PRECONDITION, ai);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.gc = function(t) {
        var e = this;
        return wo(t).get(Wi.key).next((function(t) {
            if (null !== t && e.lc(t.leaseTimestampMs, 5e3) && !e.dc(t.ownerId) && !e.cc(t) && !(e.La || e.allowTabSynchronization && t.allowTabSynchronization)) throw new I(b.FAILED_PRECONDITION, yo);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.oc = function(t) {
        ...
        return n.get(Wi.key).next((function(t) {
            return e.cc(t) ? (T("IndexedDbPersistence", "Releasing primary lease."), n.delete(Wi.key)) : Tr.resolve();
        }));
    }, 
...
var To = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.Nc = gt.min(), this.vr = t.Ic(n), this.Fc = t.Rc(), this.Ha = t.Ac(), this.$c = new hi(this.Fc, this.vr, this.persistence.Pc()), 
        this.Sc.xc(this.$c);
    }
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                s = s.next((function() {
                    ...
                    x(null !== s), (!o || o.version.L(s) < 0) && ((o = i.ar(t, o, n)) && 
     ...
     */
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Ht.forEach((function(a, c) {
                ...
                u = u.rt(a, c)) : T("LocalStore", "Ignoring outdated watch update for ", a, ". Current version:", h.version, " Watch version:", c.version), 
...
function ko(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = k(t), o = e.Dc.get(r), s = i ? "readwrite" : "readwrite-primary", n.label = 1;
 ...
 */ function Oo(t, e, n) {
    var r = k(t), i = gt.min(), o = Qt();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = k(t), i = r.Cc.get(n);
...
// PORTING NOTE: Multi-Tab only.
function Ro(t, e) {
    var n = k(t), r = k(n.Ha), i = n.Dc.get(e);
 ...
 */ var Uo = /** @class */ function() {
    ...
    t.prototype.Wc = function(t) {
        var e = this, n = new M(new P([])), r = new Po(n, t), i = new Po(n, t + 1), o = [];
        ...
        var e = new M(new P([])), n = new Po(e, t), r = new Po(e, t + 1), i = Qt();
        return this.Lc.Nt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.zo = function(t) {
        var e = new Po(t, 0), n = this.Mc.$t(e);
    ...
    return t.Oc = function(t, e) {
        return M.i(t.key, e.key) || st(t.Gc, e.Gc);
    }, 
    /** Compare by ID then by key */ t.Bc = function(t, e) {
        return st(t.Gc, e.Gc) || M.i(t.key, e.key);
    }, t;
}(), Vo = function(t, e) {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.eu !== e ? (T("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (x("string" == typeof n.accessToken), new Vo(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.nu = function() {
        ...
        return x(null === t || "string" == typeof t), new Wr(t);
    }, t;
}(), Fo = /** @class */ function() {
    function t(t, e) {
    ...
    t.prototype.Au = function(t) {
        ...
        return function(n) {
            e._n.ds((function() {
                return e.cu === t ? n() : (T("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.gu = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Ue ? (x(void 0 === e || "string" == typeof e), ct.fromBase64String(e || "")) : (x(void 0 === e || e instanceof Uint8Array), 
    ...
    return t(n, e), Object.defineProperty(n.prototype, "Du", {
        /**
    ...
    n.prototype.start = function() {
        ...
        x(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Su) {
        ...
        // The first response is always the handshake response
                return x(!t.writeResults || 0 === t.writeResults.length), this.Su = !0, 
        this.listener.Fu();
    }, 
    /**
    ...
    return t(n, e), n.prototype.ku = function() {
        if (this.xu) throw new I(b.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.qu ? (N(e), this.qu = !1) : T("OnlineStateTracker", e);
        ...
        i.ds((function() {
            return e(u, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ns(this) ? (T("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                var e;
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = k(t)).Xu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Yo(e) ];
...
function Ho(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = k(t), T("RemoteStore", "RemoteStore shutting down."), e.Xu.add(5 /* Shutdown */), 
                [ 4 /*yield*/ , Yo(e) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              ...
              case 6:
                if (r instanceof Zt ? t.sh.pe(r) : r instanceof te ? t.sh.$e(r) : t.sh.Se(r), i.isEqual(gt.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;
              ...
              case 11:
                return T("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , us(t, u) ];
...
function cs(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = k(t), r = gs(e), i = e.Yu.length > 0 ? e.Yu[e.Yu.length - 1].batchId : -1, n.label = 1;
 ...
 */ function ys(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = k(t), r ? (e.Xu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Wo(e) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  ...
                  case 3:
                    e.sent(), t.Yu.length > 0 && (T("RemoteStore", "Stopping write stream with " + t.Yu.length + " pending writes"), 
                    t.Yu = []), e.label = 4;
...
n) {
    ...
    r, i, o) {
        ...
        this.Fh = {}, this.$h = new yt((function(t) {
            return nr(t);
        }), er), this.xh = new Map, 
        /**
        ...
        return n(this, (function(l) {
            switch (l.label) {
              ...
              case 1:
                ...
                h = u.gr(a, 
                /* updateLimboDocuments= */ t.Wh, c), Cs(t, i, h.gh), f = new Es(r, i, u), [ 2 /*return*/ , (t.$h.set(r, f), 
                t.xh.has(i) ? t.xh.get(i).push(r) : t.xh.set(i, [ r ]), h.snapshot) ];
            }
        }));
    }));
}
...
/** Stops listening to the query. */ function Ss(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = k(t), i = e.$h.get(r), (o = e.xh.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.xh.set(i.targetId, o.filter((function(t) {
                    return !er(t, r);
                }))), void e.$h.delete(r)) ] : e.Wh ? (
            ...
            switch (n.label) {
              ...
              case 2:
                ...
                r.Gt.forEach((function(t, n) {
                    ...
                    x(t.te.size + t.ee.size + t.ne.size <= 1), t.te.size > 0 ? r.bh = !0 : t.ee.size > 0 ? x(r.bh) : t.ne.size > 0 && (x(r.bh), 
                    r.bh = !1));
                })), [ 4 /*yield*/ , qs(e, i, r) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = k(t)).Ch.Ui(r, "rejected", i), o = e.Oh.get(r), (s = o && o.key) ? (u = (u = new Lt(M.i)).rt(s, new qn(s, gt.min())), 
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                ...
                Us(e, i, /*error=*/ null), Ls(e, i), e.Ch.xi(i, "acknowledged"), [ 4 /*yield*/ , qs(e, o) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
                ...
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.vr.Mo(t, e).next((function(e) {
                            return x(null !== e), r = e.keys(), n.vr.Qo(t, e);
                        })).next((function() {
                            return n.vr.Go(t);
                        })).next((function() {
                            return n.$c.$r(t, r);
              ...
              case 2:
                ...
                // listen events.
                Us(e, r, i), Ls(e, r), e.Ch.xi(r, "rejected", i), [ 4 /*yield*/ , qs(e, o) ];
...
function Us(t, e, n) {
    var r = k(t), i = r.Bh[r.currentUser.Zs()];
...
function Cs(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof ws ? (t.Lh.Fa(o.key, e), Ms(t, o)) : o instanceof bs ? (T("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function Ms(t, e) {
    var n = e.key;
    t.Mh.get(n) || (T("SyncEngine", "New document in limbo: " + n), t.kh.push(n), Fs(t));
}
...
function qs(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = k(t), s = [], u = [], a = [], o.$h.m() ? [ 3 /*break*/ , 3 ] : (o.$h.forEach((function(t, e) {
                                    ...
                                    return Tr.forEach(r, (function(n) {
                                        return Tr.forEach(n.jr, (function(r) {
                                            ...
                                            return Tr.forEach(n.Kr, (function(r) {
                                                return e.persistence.Co.xa(t, n.targetId, r);
                                            }));
                                        }));
                                    }));
                                })) ];
...
function Gs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(s) {
            switch (s.label) {
              case 0:
                return (i = k(t)).currentUser.isEqual(r) ? [ 3 /*break*/ , 3 ] : (T("SyncEngine", "User change. New user:", r.Zs()), 
                [ 4 /*yield*/ , 
                /**
                ...
                function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return e = k(t), i = e.vr, o = e.$c, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                              ...
                              case 1:
                                return s = n.sent(), [ 2 /*return*/ , (e.vr = i, e.$c = o, e.Sc.xc(e.$c), s) ];
                            }
                        }));
                    }));
                }(i.Gu, r) ]);
...
function Bs(t, e) {
    var n = k(t), r = n.Oh.get(e);
    if (r && r.bh) return Qt().add(r.key);
    var i = Qt(), o = n.xh.get(e);
    if (!o) return i;
 ...
 */ function js(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Oo((e = k(t)).Gu, r.query, 
                /* usePreviousResults= */ !0) ];
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Oo(t, e).next((function(e) {
                            return e ? n.$c.$r(t, e) : Tr.resolve(null);
                        }));
                    }));
                }((e = k(t)).Gu, r) ];
...
function Qs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return Xs(e = k(t)), Js(e), !0 !== r || !0 === e.Qh ? [ 3 /*break*/ , 3 ] : (i = e.Ch.Di(), 
                [ 4 /*yield*/ , Ks(e, i.A()) ]);
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Oh.forEach((function(t, n) {
                        Xo(e.Sh, n);
                    })), e.Lh.jc(), e.Oh = new Map, e.Mh = new Lt(M.i);
...
function Ks(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = k(t), i = [], o = [], s = 0, u = r, n.label = 1;

              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = e.xh.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , xo(e.Gu, Xn(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (p = l[f], d = e.$h.get(p), [ 4 /*yield*/ , js(e, d) ]) : [ 3 /*break*/ , 6 ];
...
function Ys(t) {
    var e = k(t);
    return k(k(e.Gu).persistence).Vi();
}
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                if (!e.xh.has(r)) return [ 3 /*break*/ , 8 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 2 ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(d) {
            switch (d.label) {
              ...
              case 1:
                return o < s.length ? (u = s[o], e.xh.has(u) ? (
                // A target might have been added in a previous attempt
                T("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Ro(e.Gu, u) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 6:
                h = function(t) {
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e.xh.has(t) ? [ 4 /*yield*/ , ko(e.Gu, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                Xo(e.Sh, t), Ps(e, t);
                            })).catch(Lo) ] : [ 3 /*break*/ , 2 ];
 ...
 */ var Zs = /** @class */ function() {
    ...
    return t.prototype.xc = function(t) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var u = i.Xh(e, o);
            return (Qn(e) || Kn(e)) && i.Ah(e.on, u, r, n) ? i.Jh(t, e) : (_() <= s.DEBUG && T("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), rr(e)), 
    ...
    t.prototype.Ah = function(t, e, n, r) {
        ...
        return _() <= s.DEBUG && T("IndexFreeQueryEngine", "Using full collection scan to execute query:", rr(e)), 
    ...
    return t.prototype.$o = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                M.F(i) || (i = i.child(""));
        var o = new Po(new M(i), 0), s = new Vt(st);
        ...
        var n = this;
        x(0 === this.il(e.batchId, "removed")), this.vr.shift();
        var r = this.tl;
        ...
        var n = new Po(e, 0), r = this.tl.$t(n);
    ...
    t.prototype.Ir = function(t) {
        ...
        for (var r = Bt(), i = new M(e.path.child("")), o = this.docs._t(i)
...
var nu = /** @class */ function() {
    ...
    return t.prototype.start = function() {
        ...
        return Tr.xn(Object.values(this.ll).map((function(n) {
            return function() {
                return n.zo(t, e);
            };
        })));
    ...
    return t.El = function(e) {
        ...
        return this.ml.xa(n, e), this.Il.add(n.toString()), Tr.resolve();
    }, t.prototype.Ko = function(t, e) {
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.$l = function(t, e, n, r) {
        ...
        var n = [ this.Dl, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = m(), i = {
        ...
        return y(g.EventType.OPEN, (function() {
            ...
            d || (d = !0, T("Connection", "WebChannel transport closed"), v.bl());
        })), y(g.EventType.ERROR, (function(t) {
            d || (d = !0, A("Connection", "WebChannel transport errored:", t), v.bl(new I(b.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    d = !0, v.bl(new I(u, a)), s.close();
                } else T("Connection", "WebChannel received:", n), v.vl(n);
            }
        })), setTimeout((function() {
 ...
 */ var lu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", pu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t.persistenceSettings.Gl) throw new I(b.FAILED_PRECONDITION, lu);
        return new ru(ou.El);
        ...
        throw new I(b.FAILED_PRECONDITION, lu);
    }, t;
}(), du = /** @class */ function(r) {
    function i() {
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        ...
        if (t.persistenceSettings.Gl && t.persistenceSettings.synchronizeTabs) {
            var e = Ur();
            if (!ri.On(e)) throw new I(b.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
                  ...
                  case 1:
                    return i.sent(), [ 4 /*yield*/ , function(t) {
                        return e(this, void 0, void 0, (function() {
                            var e, r;
                            return n(this, (function(n) {
                                return e = k(t), r = k(e.Fc), [ 2 /*return*/ , e.persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                                    return r.oa(t);
                                })).then((function(t) {
                                    e.Nc = t;
                                })) ];
    ...
    for (var e = 0; e < t.length; ++e) if (j("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new I(b.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.n_ = new C(t);
}, gu = /** @class */ function(e) {
    /**
...
function(t) {
    ...
    return t(n, e), n.prototype.i_ = function(t) {
...
var _u = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.i_ = function(t) {
        var e = new pn(t.serializer, xe(t.serializer, this.h_));
        return new mn(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(bu), Su = /** @class */ function() {
    /**
     ...
     */
    function t(t, e) {
        if (q("GeoPoint", arguments, 2), j("GeoPoint", "number", 1, t), j("GeoPoint", "number", 2, e), 
...
/** A "context" object passed around while parsing user data. */ var Uu = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.I_ = function(e) {
        ...
        return Ku(t, this.settings.methodName, this.settings.y_ || !1, this.path, this.settings.a_);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Lu(this.r_) && xu.test(t)) throw this.o_('Document fields cannot begin and end with "__"');
    }, t;
}(), Pu = /** @class */ function() {
    function t(t, e, n) {
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function Vu(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.V_(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    ju("Data must be an object, but it was:", s, r);
    var u, a, c = Gu(r, s);
    ...
    return new Ou(new Pn(c), u, a);
}

/** Parse update data from an update() call. */ function Cu(t, e, n, r) {
    var i = t.V_(1 /* Update */ , e, n);
    ju("Data must be an object, but it was:", i, r);
    var o = [], s = new Vn;
    R(r, (function(t, r) {
        var u = Qu(e, t, n), a = i.P_(u);
        if (r instanceof Iu || r instanceof Du && r.f_ instanceof Iu) 
    ...
    var u = new yn(o);
    return new Ru(s.Je(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Mu(t, e, n, r, i, o) {
    var s = t.V_(1 /* Update */ , e, n), u = [ zu(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(zu(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new Vn, l = u.length - 1; l >= 0; --l) if (!Wu(h, u[l])) {
 ...
 */ function Fu(t, e, n, r) {
    return void 0 === r && (r = !1), qu(n, t.V_(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function qu(t, e) {
    ...
    // from firestore-exp.
    t instanceof Du && (t = t.f_), Bu(t)) return ju("Unsupported field value:", e, t), 
    Gu(t, e);
    if (t instanceof bu) 
    ...
    return function(t, e) {
        ...
        if (!Lu(e.r_)) throw e.o_(t.s_ + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.o_("Unsupported field value: " + X(t));
    }(t, e);
}
...
function Gu(t, e) {
    ...
    e.path && e.path.length > 0 && e.Qe.push(e.path) : R(t, (function(t, r) {
        var i = qu(r, e.A_(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function Bu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof mt || t instanceof Su || t instanceof ht || t instanceof ku || t instanceof bu);
}
 ...
 */ function zu(t, e, n) {
    ...
    throw Ku("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function Qu(t, e, n) {
    try {
        return function(t) {
            if (t.search(wu) >= 0) throw new I(b.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (gu.bind.apply(gu, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new I(b.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).n_;
    } catch (e) {
        throw Ku((i = e) instanceof Error ? i.message : i.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
 ...
 */ var Yu = /** @class */ function() {
    ...
    return t.prototype.D_ = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.C_(), this.mutations.length > 0) throw new I(b.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = k(t), i = qe(e.serializer) + "/documents", o = {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof qn || t instanceof Fn ? i.N_(t) : D();
                    })), r) ];
                }
            }));
        }));
    ...
    return t.prototype.run = function() {
        ...
        this.gs.Rn((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Yu(this.zu), (e = this.M_(t)) && e.then((function(e) {
                        r.os.ds((function() {
    ...
    return t.prototype.start = function(t, r, i, o) {
        ...
        return this.credentials.Jc((function(t) {
            if (!a) return a = !0, T("FirestoreClient", "Initializing. user=", t.uid), s.U_(r, i, o, t, u).then(s.B_.resolve, s.B_.reject);
            s.os.Ds((function() {
                return function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return (e = k(t)).os.Fs(), T("RemoteStore", "RemoteStore received new credentials"), 
                                i = ns(e), 
    ...
    t.prototype.q_ = function() {
        if (this.os.Vs) throw new I(b.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
            ...
            return t.persistence.sc(!1), function(t) {
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return (e = k(t)).Xu.add(0 /* UserDisabled */), [ 4 /*yield*/ , Yo(e) ];
            ...
            return function(t, r) {
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            ns((e = k(t)).Sh) || T("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                            n.label = 1;
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 1:
                                        return (e = n.sent()) instanceof Fn ? i.resolve(e) : e instanceof qn ? i.resolve(null) : i.reject(new I(b.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            ...
                            function(t, e) {
                                var n, r = k(t), i = mt.now(), o = e.reduce((function(t, e) {
                                    return t.add(e.key);
                                }), Qt());
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new Er;
        return this.os.ds((function() {
            return new Hu(e.os, e.zu, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var Ju = /** @class */ function() {
    ...
    return t.prototype.tf = function(t) {
        ...
        return new Su(ye(t.latitude), ye(t.longitude));
        ...
        var e = P.P(t);
        x(nn(e));
        var n = new vt(e.get(1), e.get(3)), r = new M(e.u(5));
    ...
    function t(t) {
        ...
        K("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = vi.lo; else {
            if (t.cacheSizeBytes !== Zu && t.cacheSizeBytes < vi.ho) throw new I(b.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + vi.ho);
    ...
    return Object.defineProperty(t.prototype, "Ef", {
        get: function() {
            ...
            this.If = new Pu(this.d_, this.Tf.ignoreUndefinedProperties)), this.If;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        q("Firestore.settings", arguments, 1), j("Firestore.settings", "object", 1, t), 
        t.merge && 
        // Remove the property from the settings once the merge is completed
        delete (t = Object.assign(Object.assign({}, this.Tf), t)).merge;
        var e = new ta(t);
        if (this.ff && !this.Tf.isEqual(e)) throw new I(b.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.ff) throw new I(b.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.ff && !this.ff.Y_) throw new I(b.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        ...
        if (this._f(), Xu(t)) return this.ff.H_(t);
        ...
        var r = this.Pf();
        return this.ff = new $u(this.mf, this.lf), this.ff.start(r, t, e, n);
    }, t.df = function(t) {
        ...
        get: function() {
            if (!this.hf) throw new I(b.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.hf;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return q("Firestore.collection", arguments, 1), j("Firestore.collection", "non-empty string", 1, t), 
        this._f(), new ya(P.P(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return q("Firestore.doc", arguments, 1), j("Firestore.doc", "non-empty string", 1, t), 
        this._f(), ia.gf(P.P(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (q("Firestore.collectionGroup", arguments, 1), j("Firestore.collectionGroup", "non-empty string", 1, t), 
 ...
 */
        ...
        var e = this;
        return q("Firestore.runTransaction", arguments, 1), j("Firestore.runTransaction", "function", 1, t), 
        this._f().transaction((function(n) {
            return t(new na(e, n));
        }));
    }, t.prototype.batch = function() {
        return this._f(), new ra(this);
    ...
    return t.prototype.get = function(t) {
        ...
        var n = ba("Transaction.get", t, this.pf);
        return this.bf.D_([ n.w_ ]).then((function(t) {
            if (!t || 1 !== t.length) return D();
            var r = t[0];
            if (r instanceof qn) return new sa(e.pf, n.w_, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.m_);
            if (r instanceof Fn) return new sa(e.pf, n.w_, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.m_);
            throw D();
        }));
        ...
        var r = ba("Transaction.set", t, this.pf);
        n = ma("Transaction.set", n);
        var i = Ea(r.m_, e, n), o = Vu(this.pf.Ef, "Transaction.set", r.w_, i, null !== r.m_, n);
        return this.bf.set(r.w_, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof gu ? (G("Transaction.update", arguments, 3), 
        r = ba("Transaction.update", t, this.pf), i = Mu(this.pf.Ef, "Transaction.update", r.w_, e, n, o)) : (q("Transaction.update", arguments, 2), 
        r = ba("Transaction.update", t, this.pf), i = Cu(this.pf.Ef, "Transaction.update", r.w_, e)), 
        this.bf.update(r.w_, i), this;
    }, t.prototype.delete = function(t) {
        q("Transaction.delete", arguments, 1);
        var e = ba("Transaction.delete", t, this.pf);
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = ba("WriteBatch.set", t, this.pf);
        n = ma("WriteBatch.set", n);
        var i = Ea(r.m_, e, n), o = Vu(this.pf.Ef, "WriteBatch.set", r.w_, i, null !== r.m_, n);
        return this.vf = this.vf.concat(o.T_(r.w_, wn.Ge())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Df(), "string" == typeof e || e instanceof gu ? (G("WriteBatch.update", arguments, 3), 
        r = ba("WriteBatch.update", t, this.pf), i = Mu(this.pf.Ef, "WriteBatch.update", r.w_, e, n, o)) : (q("WriteBatch.update", arguments, 2), 
        r = ba("WriteBatch.update", t, this.pf), i = Cu(this.pf.Ef, "WriteBatch.update", r.w_, e)), 
        this.vf = this.vf.concat(i.T_(r.w_, wn.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        q("WriteBatch.delete", arguments, 1), this.Df();
        var e = ba("WriteBatch.delete", t, this.pf);
        ...
        if (this.Sf) throw new I(b.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), ia = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.gf = function(t, e, r) {
        ...
        get: function() {
            return new ya(this.w_.path.h(), this.firestore, this.m_);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (q("DocumentReference.collection", arguments, 1), j("DocumentReference.collection", "non-empty string", 1, t), 
        ...
        B("DocumentReference.set", arguments, 1, 2), e = ma("DocumentReference.set", e);
        var n = Ea(this.m_, t, e), r = Vu(this.firestore.Ef, "DocumentReference.set", this.w_, n, null !== this.m_, e);
        return this.ff.write(r.T_(this.w_, wn.Ge()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof gu ? (G("DocumentReference.update", arguments, 2), 
        n = Mu(this.firestore.Ef, "DocumentReference.update", this.w_, t, e, r)) : (q("DocumentReference.update", arguments, 1), 
        n = Cu(this.firestore.Ef, "DocumentReference.update", this.w_, t)), this.ff.write(n.T_(this.w_, wn.exists(!0)));
    }, n.prototype.delete = function() {
        return q("DocumentReference.delete", arguments, 0), this.ff.write([ new Ln(this.w_, wn.Ge()) ]);
        ...
        "object" != typeof i[u] || Xu(i[u]) || (Z("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        return t && "cache" === t.source ? n.j_(this.w_).then((function(t) {
            return new sa(e.firestore, e.w_, t, 
    ...
    n.prototype.Cf = function(t) {
        ...
        return new sa(this.firestore, this.w_, e, t.fromCache, t.hasPendingWrites, this.m_);
    }, n;
}(ku), oa = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (B("DocumentSnapshot.data", arguments, 0, 1), t = ga("DocumentSnapshot.data", t), 
        this.Nf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.m_) {
                var n = new ua(this.pf, this.w_, this.Nf, this.Ff, this.$f, 
                /* converter= */ null);
                return this.m_.fromFirestore(n, t);
            }
            return new Ju(this.pf.d_, this.pf.yf(), t.serverTimestamps || "none", (function(t) {
                return new ia(t, e.pf, /* converter= */ null);
            }), (function(t) {
                return new pt(t);
            })).tf(this.Nf.sn());
        }
        ...
        var n = this;
        if (B("DocumentSnapshot.get", arguments, 1, 2), e = ga("DocumentSnapshot.get", e), 
        this.Nf) {
            var r = this.Nf.data().field(zu("DocumentSnapshot.get", t, this.w_));
            if (null !== r) return new Ju(this.pf.d_, this.pf.yf(), e.serverTimestamps || "none", (function(t) {
                return new ia(t, n.pf, n.m_);
            }), (function(t) {
                return new pt(t);
            })).tf(r);
        }
...
function aa(t, e, n, r, i, o, s) {
    ...
    } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || fa(s, o), 
    u = Fu(n, e, s, 
...
function ha(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!Hn(e) && -1 !== n.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(P.P(n));
        if (!M.F(r)) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return ge(t, new M(r));
    }
    if (n instanceof ku) return ge(t, n.w_);
...
function pa(t) {
    if (Kn(t) && 0 === t.rn.length) throw new I(b.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var da = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i = Y("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , "!=" /* NOT_EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ , "not-in" /* NOT_IN */ ], 2, n), o = zu("Query.where", e), s = aa(this.xf, "Query.where", this.firestore.Ef, this.firestore.d_, o, i, r);
        ...
        var i = zu("Query.orderBy", e), o = ca(this.xf, i, r);
        return new t(function(t, e) {
        ...
        return q("Query.limit", arguments, 1), j("Query.limit", "number", 1, e), et("Query.limit", 1, e), 
        new t(Jn(this.xf, e, "F" /* First */), this.firestore, this.m_);
    }, t.prototype.limitToLast = function(e) {
        return q("Query.limitToLast", arguments, 1), j("Query.limitToLast", "number", 1, e), 
        et("Query.limitToLast", 1, e), new t(Jn(this.xf, e, "L" /* Last */), this.firestore, this.m_);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        G("Query.startAt", arguments, 1);
        var i = this.kf("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(Zn(this.xf, i), this.firestore, this.m_);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        G("Query.startAfter", arguments, 1);
        var i = this.kf("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(Zn(this.xf, i), this.firestore, this.m_);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        G("Query.endBefore", arguments, 1);
        var i = this.kf("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(tr(this.xf, i), this.firestore, this.m_);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        G("Query.endAt", arguments, 1);
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.kf = function(t, e, n, i) {
        if (J(t, 1, e), e instanceof sa) return q(t, r([ e ], n), 1), function(t, e, n, r, i) {
            ...
            return new vr(o, i);
        }(this.xf, this.firestore.d_, t, e.Nf, i);
        var o = [ e ].concat(n);
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.p()) {
                    ...
                    if (!Hn(t) && -1 !== c.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(P.P(c));
                    if (!M.F(h)) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new M(h);
                    u.push(ge(e, f));
                } else {
                    var l = Fu(n, r, c);
            ...
            return new vr(u, o);
        }(this.xf, this.firestore.d_, this.firestore.Ef, t, o, i);
    }, t.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        B("Query.onSnapshot", arguments, 1, 4);
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Xu(i[u]) || (Z("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        var c = {
            next: function(t) {
                i[u] && i[u](new va(r.firestore, r.xf, t, r.m_));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return pa(this.xf), this.firestore._f().listen(this.xf, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        B("Query.get", arguments, 0, 1), wa("Query.get", t), pa(this.xf);
        var n = this.firestore._f();
        return (t && "cache" === t.source ? n.G_(this.xf) : n.z_(this.xf, t)).then((function(t) {
            return new va(e.firestore, e.xf, t, e.m_);
        }));
    }, t;
}(), va = /** @class */ function() {
    function t(t, e, n, r) {
        this.pf = t, this.Mf = e, this.Of = n, this.m_ = r, this.Lf = null, this.Bf = null, 
        this.metadata = new oa(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return new da(this.Mf, this.pf, this.m_);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (Z("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), K("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.Of.jt) throw new I(b.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new ua(this.pf, t.key, t, e, n, this.m_);
    }, t;
}(), ya = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, zn(t), n, r) || this).Uf = t, t.length % 2 != 1) throw new I(b.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.R() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.m() ? null : new ia(new M(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        var e = P.P(t);
        return ia.gf(this.xf.path.child(e), this.firestore, this.m_);
        ...
        // Call set() with the converted value directly to avoid calling toFirestore() a second time.
                return new ia(n.w_, this.firestore, null).set(e).then((function() {
            return n;
        }));
    }, n.prototype.withConverter = function(t) {
...
function ma(t, e) {
    ...
    if (Z(t, e, [ "merge", "mergeFields" ]), K(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
...
function wa(t, e) {
    z(t, "object", 1, e), e && (Z(t, e, [ "source" ]), W(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
 ...
 */
        function() {
            ...
            // update() since we'd need the Firestore instance to do this.
                        return G("arrayUnion()", arguments, 1), new Tu("arrayUnion", t);
        }.apply(void 0, t);
        return r.s_ = "FieldValue.arrayUnion", new n(r);
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        G("FieldValue.arrayRemove", arguments, 1);
        var r = function() {
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            // NOTE: We don't actually parse the data until it's used in set() or
            // update() since we'd need the Firestore instance to do this.
                        return G("arrayRemove()", arguments, 1), new Nu("arrayRemove", t);
        }.apply(void 0, t);
        return r.s_ = "FieldValue.arrayRemove", new n(r);
    }, n.increment = function(t) {
        j("FieldValue.increment", "number", 1, t), q("FieldValue.increment", arguments, 1);
        var e = function(t) {
    ...
    DocumentSnapshot: sa,
    Query: da,
    QueryDocumentSnapshot: ua,
    QuerySnapshot: va,
    CollectionReference: ya,
    FieldPath: gu,
    FieldValue: _a,
    setLogLevel: ea.setLogLevel,
    ...
    !function(t, e) {
        t.INTERNAL.registerComponent(new w("firestore", (function(t) {
            return function(t, e) {
                ...
                return new ea(t, e, r, n);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Ta)));
    }(t), t.registerVersion("@firebase/firestore", "1.17.2");
}

Na(i);

export { Na as __PRIVATE_registerFirestore };
