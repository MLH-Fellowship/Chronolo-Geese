...
}(_), A = /^[_a-zA-Z][_a-zA-Z0-9]*$/, T = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t.__extends(n, e), n.prototype.o = function(t, e, r) {
 ...
 */ function x(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new c(a.INVALID_ARGUMENT, "Invalid value " + j(r) + " provided to function " + t + "() for its " + z(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
/** Returns a string describing the type / value of the provided input. */ function j(t) {
...
var X = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            return new t(K.fromBase64String(e));
        } catch (e) {
     ...
     */
    t.fromUint8Array = function(e) {
        return new t(K.fromUint8Array(e));
    }, 
    /**
...
/** Helper function to assert Base64 functions are available at runtime. */ function $() {
 ...
 */ var tt = /** @class */ function(e) {
    ...
    return t.__extends(n, e), n.fromBase64String = function(t) {
        ...
        $();
        try {
            return new n(K.fromBase64String(t));
        } catch (t) {
            throw new c(a.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }, n.fromUint8Array = function(t) {
        if (V("Blob.fromUint8Array", arguments, 1), Z(), !(t instanceof Uint8Array)) throw F("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new n(K.fromUint8Array(t));
    }, n.prototype.toBase64 = function() {
        return V("Blob.toBase64", arguments, 0), $(), e.prototype.toBase64.call(this);
    }, n.prototype.toUint8Array = function() {
        return V("Blob.toUint8Array", arguments, 0), Z(), e.prototype.toUint8Array.call(this);
    }, n.prototype.toString = function() {
    ...
    if (null === e.Z) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return function(t) {
                ...
                return t.field.R() + t.op.toString() + te(t.value);
            }(t);
        })).join(","), n += "|ob:", n += e.orderBy.map((function(t) {
            return (e = t).field.R() + e.dir;
            var e;
        })).join(","), st(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += Yn(e.startAt)), e.endAt && (n += "|ub:", n += Yn(e.endAt)), e.Z = n;
    }
    return e.Z;
}
...
function ft(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!Zn(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (var r = 0; r < t.filters.length; r++) if (i = t.filters[r], o = e.filters[r], 
    i.op !== o.op || !i.field.isEqual(o.field) || !Kt(i.value, o.value)) return !1;
    var i, o;
 ...
 */ var pt, dt, vt = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = ot.min()), void 0 === o && (o = ot.min()), void 0 === s && (s = K.q), 
...
var wt = /** @class */ function() {
    ...
    t.prototype.Dt = function() {
        if (this.Pt() && this.left.Pt()) throw y();
        if (this.right.Pt()) throw y();
        var t = this.left.Dt();
        if (t !== this.right.Dt()) throw y();
...
var _t = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.$t = function(t) {
        ...
        return new It(this.data.lt());
    }, t.prototype._t = function(t) {
        return new It(this.data._t(t));
    }, 
...
var Lt = new wt(N.i), Rt = new _t(N.i);
 ...
 */ var St = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Ot = Vt(), this.Mt = new wt(this.i)
        /**
    ...
    return t.Gt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.jt === t.jt && this.Qt.isEqual(t.Qt) && kn(this.query, t.query) && this.docs.isEqual(t.docs) && this.Bt.isEqual(t.Bt))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Mt.Xt(e, n)), new t(ot.min(), r, Pt(), Tt(), Ut());
    }, t;
}(), Mt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = K.q), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.de = function() {
        ...
        })), new Mt(this.ce, this.ae, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.we = function() {
        this.he = !1, this.ue = Qt();
    ...
    return t.prototype.Ve = function(t) {
        for (var e = 0, n = t.se; e < n.length; e++) {
            var r = n[e];
            t.ie instanceof gn ? this.ve(r, t.ie) : t.ie instanceof mn && this.be(r, t.key, t.ie);
        }
    ...
    t.prototype.$e = function(t) {
        ...
        if (r) {
            ...
            if (lt(i)) if (0 === n) {
                ...
                // queries.
                var o = new N(i.path);
                this.be(e, o, new mn(o, ot.min()));
            } else g(1 === n); else this.xe(e) !== n && (
    ...
    t.prototype.Oe = function(t) {
        ...
        this.ye.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Zt && lt(o.target)) {
                    ...
                    null !== e.Pe.get(s) || e.Me(i, s) || e.be(i, s, new mn(s, t));
                }
        ...
        var i = new Ct(t, n, this.ge, this.Pe, r);
        return this.Pe = Tt(), this.pe = zt(), this.ge = new _t(H), i;
    }, 
    /**
    ...
    t.prototype.Ee = function(t) {
        ...
        var e = this.ye.get(t);
        return e || (e = new Ft, this.ye.set(t, e)), e;
    }, t.prototype.Le = function(t) {
        var e = this.pe.get(t);
        return e || (e = new _t(H), this.pe = this.pe.rt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Ne = function(t) {
        var e = this;
        this.ye.set(t, new Ft), this.Re.qe(t).forEach((function(n) {
...
/** Extracts the backend's type order for the provided value. */ function Jt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Wt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : y();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Kt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return J(t.arrayValue.values || [], e.arrayValue.values || [], Kt);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (w(n) !== w(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !Kt(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function Zt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = H(ne(t.latitude), ne(e.latitude));
            return 0 !== n ? n : H(ne(t.longitude), ne(e.longitude));
...
function $t(t, e) {
    ...
    var n = ee(t), r = ee(e), i = H(n.seconds, r.seconds);
...
function te(t) {
    return function t(e) {
        ...
        }(e.timestampValue) : "stringValue" in e ? e.stringValue : "bytesValue" in e ? re(e.bytesValue).toBase64() : "referenceValue" in e ? (r = e.referenceValue, 
        N.D(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
/** Returns true if `value` is an IntegerValue . */ function oe(t) {
...
/** Returns true if `value` is a NullValue. */ function ue(t) {
...
function _e(t, e) {
    ...
    new N((g((n = r).length > 4 && "documents" === n.get(4)), n.u(5)));
}
...
function Ve(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Ie(t, r), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = Ie(t, r.h()), n.structuredQuery.from = [ {
        collectionId: r._()
    } ]);
    var i = function(t) {
        if (0 !== t.length) {
 ...
 */ function xe(t, e, n) {
    ...
    }(n, e) : t instanceof qe ? Be(t, e) : t instanceof Fe ? Ge(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Me(t, e), r = Qe(n) + Qe(t.je);
        return oe(n) && oe(t.je) ? pe(r) : de(t.serializer, r);
    }(t, e);
}
 ...
 */ function Ce(t, e, n) {
    ...
    // applications.
    return t instanceof qe ? Be(t, e) : t instanceof Fe ? Ge(t, e) : n;
}
 ...
 */ function Me(t, e) {
    return t instanceof ze ? oe(n = e) || function(t) {
 ...
 */ var Ye = /** @class */ function() {
    ...
    return t.prototype.Ke = function(t) {
        ...
        return J(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), He = function(t, e) {
 ...
 */ function $e(t, e, n) {
    return t instanceof on ? function(t, e, n) {
    ...
    }(t, 0, n) : t instanceof sn ? function(t, e, n) {
        if (!Xe(t.Ge, e)) 
        ...
        var r = un(t, e);
        return new gn(t.key, n.version, r, {
            hasCommittedMutations: !0
        });
    }(t, e, n) : t instanceof an ? function(t, e, n) {
        if (g(null != n.transformResults), !Xe(t.Ge, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */
        function(t, e, n) {
            ...
            for (var i = 0; i < n.length; i++) {
                ...
                e instanceof gn && (u = e.field(o.field)), r.push(Ce(s, u, n[i]));
            }
            return r;
        }(t.fieldTransforms, e, n.transformResults), o = n.version, s = hn(t, r.data(), i);
        return new gn(t.key, o, s, {
            hasCommittedMutations: !0
        });
 ...
 */ function tn(t, e, n, r) {
    return t instanceof on ? function(t, e) {
        if (!Xe(t.Ge, e)) return e;
        var n = rn(e);
        return new gn(t.key, n, t.value, {
            Ye: !0
        });
    }(t, e) : t instanceof sn ? function(t, e) {
        if (!Xe(t.Ge, e)) return e;
        var n = rn(e), r = un(t, e);
        return new gn(t.key, n, r, {
            Ye: !0
        });
        ...
        var i = cn(t, e), o = function(t, e, n, r) {
            for (var i = [], o = 0, s = t; o < s.length; o++) {
                ...
                n instanceof gn && (c = n.field(u.field)), null === c && r instanceof gn && (
            ...
            return i;
        }(t.fieldTransforms, n, e, r), s = hn(t, i.data(), o);
        return new gn(t.key, i.version, s, {
            Ye: !0
        });
    }(t, e, r, n) : function(t, e) {
        return Xe(t.Ge, e) ? new mn(t.key, ot.min()) : e;
    }(t, e);
}
 ...
 */ function en(t, e) {
    return t instanceof an ? function(t, e) {
        for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
            var o = i[r], s = e instanceof gn ? e.field(o.field) : void 0, u = Me(o.transform, s || null);
...
function nn(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Ge.isEqual(e.Ge) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Qe.isEqual(e.Qe) : 2 /* Transform */ !== t.type || J(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof qe && e instanceof qe || t instanceof Fe && e instanceof Fe ? J(t.elements, e.elements, Kt) : t instanceof ze && e instanceof ze ? Kt(t.je, e.je) : t instanceof je && e instanceof je;
 ...
 */ function rn(t) {
    return t instanceof gn ? t.version : ot.min();
}
...
function un(t, e) {
    ...
    }(t, e instanceof gn ? e.data() : pn.empty());
}
...
/** A mutation that deletes the document at the given key. */ var fn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).key = t, r.Ge = n, r.type = 3 /* Delete */ , r;
    }
    return t.__extends(n, e), n;
}(Ze), ln = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).key = t, r.Ge = n, r.type = 4 /* Verify */ , r;
    }
    return t.__extends(n, e), n;
}(Ze), pn = /** @class */ function() {
    function t(t) {
        this.proto = t;
    }
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.proto, n = 0; n < t.length - 1; ++n) {
            ...
            if (!ce(e = e.mapValue.fields[t.get(n)])) return null;
        }
    ...
    t.prototype.en = function(t, e) {
        var n = this, r = !1, i = this.Xe.field(t), o = ce(i) ? // If there is already data at the current path, base our
 ...
 * paths.
 */ function _n(t) {
    return !st(t.limit) && "F" /* First */ === t.on;
}

function In(t) {
    return !st(t.limit) && "L" /* Last */ === t.on;
}
 ...
 */ function Dn(t) {
    ...
    if (null === e.un) {
        ...
        n.V() || e.un.push(new Kn(n)), e.un.push(new Kn(T.v(), "asc" /* ASCENDING */)); else {
 ...
 */ function Vn(t) {
    var e = m(t);
    if (!e.cn) if ("F" /* First */ === e.on) e.cn = ct(e.path, e.collectionGroup, Dn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Dn(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Kn(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Wn(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new Wn(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.cn = ct(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.cn;
}
...
function Sn(t) {
    return "Query(target=" + function(t) {
        ...
        t.filters.length > 0 && (e += ", filters: [" + t.filters.map((function(t) {
            return (e = t).field.R() + " " + e.op + " " + te(e.value);
        ...
        st(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.R() + " (" + e.dir + ")";
            var e;
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + Yn(t.startAt)), t.endAt && (e += ", endAt: " + Yn(t.endAt)), 
        "Target(" + e + ")";
    }(Vn(t)) + "; limitType=" + t.on + ")";
}

/** Returns whether `doc` matches the constraints of `query`. */ function On(t, e) {
    return function(t, e) {
        var n = e.key.path;
        ...
        return !(t.startAt && !Hn(t.startAt, Dn(t), e)) && (!t.endAt || !Hn(t.endAt, Dn(t), e));
    }(t, e);
}

function xn(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = Dn(t); i < o.length; i++) {
            var s = o[i], u = Xn(s, e, n);
            if (0 !== u) return u;
            r = r || s.field.V();
        }
        return 0;
...
var Cn = /** @class */ function(e) {
     ...
     */    return t.__extends(n, e), n.create = function(t, e, r) {
        if (t.V()) return "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.hn(t, e, r) : new Mn(t, e, r);
        if (ue(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Fn(t, r) : "in" /* IN */ === e ? new Gn(t, r) : "not-in" /* NOT_IN */ === e ? new zn(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Qn(t, r) : new n(t, e, r);
    }, n.hn = function(t, e, n) {
        return "in" /* IN */ === e ? new jn(t, n) : new qn(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.ln(Zt(e, this.value)) : null !== e && Jt(this.value) === Jt(e) && this.ln(Zt(e, this.value));
...
var Mn = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = N.D(r.referenceValue), i;
    }
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Bn("in" /* IN */ , n), 
        r;
    }
    return t.__extends(n, e), n.prototype.matches = function(t) {
...
}(Cn), qn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Bn("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t.__extends(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function Bn(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((function(t) {
        return N.D(t.referenceValue);
    }));
}
...
/** A Filter that implements the array-contains operator. */ var Fn = /** @class */ function(e) {
    ...
    return t.__extends(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return se(e) && Xt(e.arrayValue, this.value);
    }, n;
}(Cn), Gn = /** @class */ function(e) {
    function n(t, n) {
...
/** A Filter that implements the IN operator. */ function Yn(t) {
 ...
 */ function Hn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.V() ? N.i(N.D(s.referenceValue), n.key) : Zt(s, n.field(o.field)), 
...
function Jn(t, e) {
    ...
    for (var n = 0; n < t.position.length; n++) if (!Kt(t.position[n], e.position[n])) return !1;
    return !0;
}
...
function Xn(t, e, n) {
    var r = t.field.V() ? N.i(e.key, n.key) : function(t, e, n) {
 ...
 */ var $n = function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Sn && y(), this.Sn = !0, this.bn ? this.error ? this.Cn(n, this.error) : this.Dn(e, this.result) : new t((function(t, i) {
            r.Vn = function(n) {
                r.Dn(e, n).next(t, i);
            }, r.vn = function(e) {
                r.Cn(n, e).next(t, i);
 ...
 */ var ir = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.xn = t, this.fn = e, this.On = n, this.op = r, this.Mn = i, this.Ln = new $n, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.Un && (this.clearTimeout(), this.Ln.reject(new c(a.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function e() {
        ...
        this.Jn = new tr(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Xn = function() {
            var e = rr();
            e && l("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.Jn.pn();
        };
        var e = rr();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Xn);
    }
    return Object.defineProperty(e.prototype, "Zn", {
    ...
    e.prototype.os = function() {
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Wn[0]() ];

                  case 2:
                    return t.sent(), this.Wn.shift(), this.Jn.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!nr(e = t.sent())) throw e;
        ...
        var e = this, n = this.jn.then((function() {
            return e.Hn = !0, t().catch((function(t) {
                ...
                throw e.Kn = t, e.Hn = !1, p("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    e.prototype.Pn = function(t, e, n) {
        ...
        var i = ir.qn(this, t, e, n, (function(t) {
            return r.us(t);
        }));
    ...
    e.prototype.hs = function() {
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4 /*yield*/ , e = this.jn ];

                  case 1:
                    t.sent(), t.label = 2;

                  case 2:
                    if (e !== this.jn) return [ 3 /*break*/ , 0 ];
                    t.label = 3;
    ...
    /** Called once a DelayedOperation is run or canceled. */ e.prototype.us = function(t) {
 ...
 */
function sr(t, e) {
    if (p("AsyncQueue", e + ": " + t), nr(t)) return new c(a.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var ur = function() {
    ...
    this.ws = new rt((function(t) {
        return Pn(t);
    }), kn), this.onlineState = "Unknown" /* Unknown */ , this.Ts = new Set;
};
...
function cr(e, n) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                if (r = m(e), i = n.query, o = !1, (s = r.ws.get(i)) || (o = !0, s = new ur), !o) return [ 3 /*break*/ , 4 ];
                t.label = 1;

              case 1:
                return t.trys.push([ 1, 3, , 4 ]), u = s, [ 4 /*yield*/ , r.Es(i) ];

              case 2:
                return u.ds = t.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return a = t.sent(), c = sr(a, "Initialization of query '" + Sn(n.query) + "' failed"), 
                [ 2 /*return*/ , void n.onError(c) ];

              case 4:
                return r.ws.set(i, s), s.listeners.push(n), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                n.Is(r.onlineState), s.ds && n.As(s.ds) && pr(r), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function hr(e, n) {
    return t.__awaiter(this, void 0, void 0, (function() {
        var r, i, o, s, u;
        return t.__generator(this, (function(t) {
            return r = m(e), i = n.query, o = !1, (s = r.ws.get(i)) && (u = s.listeners.indexOf(n)) >= 0 && (s.listeners.splice(u, 1), 
            o = 0 === s.listeners.length), o ? [ 2 /*return*/ , (r.ws.delete(i), r.Rs(i)) ] : [ 2 /*return*/ ];
        }));
    }));
}
 ...
 */ var dr = /** @class */ function() {
    ...
    return t.prototype.As = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new xt(t.query, t.docs, t.Bt, e, t.Qt, t.fromCache, t.jt, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Is = function(t) {
        ...
        t = xt.Gt(t.query, t.docs, t.Qt, t.fromCache), this.Ps = !0, this.ys.next(t);
    }, t;
}(), vr = /** @class */ function() {
    function t(t) {
        this.uid = t;
 ...
 * readable.
 */
/** A user with a null UID. */ vr.UNAUTHENTICATED = new vr(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
vr.Ds = new vr("google-credentials-uid"), vr.Fs = new vr("first-party-uid");
...
var gr = /** @class */ function() {
    ...
    function t() {
        this.Us = new gr, this.Bs = {}, this.Qs = null, this.Ns = null;
    }
    return t.prototype.js = function(t) {
        ...
        return this.Us = new gr, Promise.resolve();
    }, t.prototype.Zs = function(t, e, n) {
        // No op.
    ...
    t.prototype.ri = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = tn(i, e, e, this.ni));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = tn(a, e, o, this.ni));
        }
        return e;
    }, 
    /**
    ...
    t.prototype.oi = function(t) {
        ...
        return this.batchId === t.batchId && J(this.mutations, t.mutations, (function(t, e) {
            return nn(t, e);
        })) && J(this.baseMutations, t.baseMutations, (function(t, e) {
            return nn(t, e);
        }));
    }, t;
}(), br = /** @class */ function() {
    ...
    t.prototype.Ei = function(t, e) {
        ...
        return this.hi.Ii(t, e).next((function(r) {
            var i = n.mi(t, e, r), o = Tt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new mn(t, ot.min())), o = o.rt(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return N.N(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Ri(t, e.path) : Nn(e) ? this.yi(t, e, n) : this.Pi(t, e, n);
    }, t.prototype.Ri = function(t, e) {
        // Just do a simple document lookup.
        return this._i(t, new N(e)).next((function(t) {
            var e = Vt();
            return t instanceof gn && (e = e.rt(t.key, t)), e;
        }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Vi(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = tn(a, h, h, o.ni);
                    r = f instanceof gn ? r.rt(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        for (var r = Ut(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
            a instanceof sn && null === n.get(a.key) && (r = r.add(a.key));
        }
        var c = n;
        return this.ai.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof gn && (c = c.rt(t, e));
            })), c;
        }));
    }, t;
}(), _r = /** @class */ function() {
 ...
 */ Ir.xi = -1, Ir.Oi = 1048576, Ir.Mi = 41943040, Ir.$i = 10, Ir.ki = 1e3, Ir.Li = new Ir(Ir.Mi, Ir.$i, Ir.ki), 
Ir.qi = new Ir(Ir.xi, 0, 0);
...
var Ar = /** @class */ function() {
    ...
    return t.prototype.Bi = function(t, e) {
        return this.Ui.add(e), er.resolve();
    }, t.prototype.pi = function(t, e) {
        return er.resolve(this.Ui.getEntries(e));
    }, t;
}(), Tr = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.Hi = ot.min(), this.hi = t.Yi(n), this.Ji = t.Xi(), this.Zi = t.tr(), this.er = new Er(this.Ji, this.hi, this.persistence.nr()), 
        this.Gi.sr(this.er);
    }
...
function Vr(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = er.resolve();
            return o.forEach((function(t) {
                s = s.next((function() {
                    return r.wi(e, t);
                })).next((function(e) {
                    var o = e, s = n.ci.get(t);
                    g(null !== s), (!o || o.version.L(s) < 0) && ((o = i.si(t, o, n)) && 
 ...
 */ function Rr(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return g(e.resumeToken.M() > 0), 0 === t.resumeToken.M() || (
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Ht.forEach((function(a, c) {
                ...
                // cache.
                                c instanceof mn && c.version.isEqual(ot.min()) ? (
    ...
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              ...
              case 5:
                return i.zi = i.zi.remove(n), i.Ki.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function Pr(t, e, n) {
     ...
     */
        ...
        return function(t, e, n) {
            var r = m(t), i = r.Ki.get(n);
            return void 0 !== i ? er.resolve(r.zi.get(i)) : r.Zi.Pr(e, n);
        }(r, t, Vn(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Zi.pr(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.Gi.Ai(t, e, n ? i : ot.min(), n ? o : Ut());
        })).next((function(t) {
            return {
                documents: t,
                gr: o
 ...
 */ var Or = /** @class */ function() {
    function t() {
        ...
        this.Vr = new _t(xr.vr), 
        // A set of outstanding references to a document sorted by target id.
        this.br = new _t(xr.Sr)
    ...
    t.prototype.kr = function(t) {
        var e = this, n = new N(new I([])), r = new xr(n, t), i = new xr(n, t + 1), o = [];
        ...
        var e = new N(new I([])), n = new xr(e, t), r = new xr(e, t + 1), i = Ut();
        return this.br.Ft([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Lr = function(t) {
        var e = new xr(t, 0), n = this.Vr.$t(e);
    ...
    return t.vr = function(t, e) {
        return N.i(t.key, e.key) || H(t.qr, e.qr);
    }, 
    /** Compare by ID then by key */ t.Sr = function(t, e) {
        return H(t.qr, e.qr) || N.i(t.key, e.key);
    }, t;
}(), Cr = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = vr.UNAUTHENTICATED, this.zr = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.Kr !== e ? (l("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (g("string" == typeof n.accessToken), new Cr(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.Hr = function() {
        ...
        return g(null === t || "string" == typeof t), new vr(t);
    }, t;
}(), qr = /** @class */ function() {
    function t(t, e) {
        this.Yr = t, this.Jr = e, this.type = "FirstParty", this.user = vr.Fs;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new qr(this.Yr, this.Jr));
    }, t.prototype.jr = function(t) {
    ...
    function e(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.no = 0, this.so = null, this.stream = null, this.Jn = new tr(t, e)
        /**
    ...
    return e.prototype.io = function() {
    ...
    /** Sends a message to the underlying stream. */ e.prototype.ho = function(t) {
        this.lo(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ e.prototype.ao = function() {
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
    ...
    /** Marks the stream as active again. */ e.prototype.lo = function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    this.state = e, [ 4 /*yield*/ , this.listener.fo(n) ];
     ...
     */
    e.prototype._o = function() {}, e.prototype.auth = function() {
        var t = this;
    ...
    e.prototype.do = function(t) {
        ...
        return function(n) {
            e._n.Qn((function() {
                return e.no === t ? n() : (l("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, e;
    ...
    return t.__extends(n, e), n.prototype.To = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Be ? (g(void 0 === e || "string" == typeof e), K.fromBase64String(e || "")) : (g(void 0 === e || e instanceof Uint8Array), 
                    K.fromUint8Array(e || new Uint8Array));
                ...
                var f = _e(t, h.document.name), l = we(h.document.updateTime), p = new pn({
                    mapValue: {
                        fields: h.document.fields
                    }
                }), d = new gn(f, l, p, {}), v = h.targetIds || [], m = h.removedTargetIds || [];
                n = new jt(v, m, d.key, d);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var w = e.documentDelete;
                w.document;
                var b = _e(t, w.document), E = w.readTime ? we(w.readTime) : ot.min(), _ = new mn(b, E), I = w.removedTargetIds || [];
                n = new jt([], I, _.key, _);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var A = e.documentRemove;
                A.document;
                var T = _e(t, A.document), N = A.removedTargetIds || [];
                n = new jt([], N, T, null);
            } else {
                ...
                var D = e.filter;
                D.targetId;
                var V = D.count || 0, L = new yt(V), R = D.targetId;
                n = new qt(R, L);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? ot.min() : e.readTime ? we(e.readTime) : ot.min();
        }(t);
    ...
    n.prototype.Ro = function(t) {
        var e = {};
        e.database = Ae(this.serializer), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = lt(r) ? {
                documents: De(t, r)
            } : {
                query: Ve(t, r)
            }).targetId = e.targetId, e.resumeToken.M() > 0 && (n.resumeToken = ge(t, e.resumeToken)), 
            n;
        }(this.serializer, t);
        var n = function(t, e) {
            var n = function(t, e) {
    ...
    n.prototype.yo = function(t) {
        var e = {};
        e.database = Ae(this.serializer), e.removeTarget = t, this.ho(e);
    }, n;
}(Fr), zr = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
    ...
    return t.__extends(n, e), Object.defineProperty(n.prototype, "po", {
        /**
    ...
    n.prototype.start = function() {
        ...
        g(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Po) {
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (g(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? we(t.updateTime) : we(e);
                        n.isEqual(ot.min()) && (
            ...
            }(t.writeResults, t.commitTime), n = we(t.commitTime);
    ...
    n.prototype.So = function() {
        ...
        var t = {};
        t.database = Ae(this.serializer), this.ho(t);
    }, 
...
}(Fr), Qr = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).credentials = t, i.Zr = n, i.serializer = r, i.Co = !1, 
        i;
    }
    return t.__extends(n, e), n.prototype.Do = function() {
    ...
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Fo = function(t, e, n) {
        ...
        return this.Do(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === a.UNAUTHENTICATED && r.credentials.Qr(), t;
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.xo ? (p(e), this.xo = !1) : l("OnlineStateTracker", e);
...
n, r, i, o) {
    var s = this;
    this.Bo = e, this.Qo = n, this.xn = r, this.jo = {}, 
    /**
    ...
    /**
             ...
             */
    this.Ko = [], this.Ho = o, this.Ho.Yo((function(e) {
        r.Qn((function() {
            return t.__awaiter(s, void 0, void 0, (function() {
                return t.__generator(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        return ri(this) ? (l("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(e) {
                            return t.__awaiter(this, void 0, void 0, (function() {
                                var n;
                                return t.__generator(this, (function(t) {
                                    switch (t.label) {
                                      case 0:
                                        return (n = m(e)).zo.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Jr(n) ];

                                      case 1:
                                        return t.sent(), n.Jo.set("Unknown" /* Unknown */), n.zo.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , Hr(n) ];
...
function Hr(e) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                if (!ri(e)) return [ 3 /*break*/ , 4 ];
                n = 0, r = e.Ko, t.label = 1;
...
function Kr(e) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                return n = m(e), l("RemoteStore", "RemoteStore shutting down."), n.zo.add(5 /* Shutdown */), 
                [ 4 /*yield*/ , Jr(n) ];

              case 1:
                return t.sent(), n.Ho.ei(), 
                // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                // triggering spurious listener events with cached data, etc.
                n.Jo.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function Zr(t, e) {
    var n = m(t), r = gi(n);
    n.Go.delete(e), r.ro() && ti(n, e), 0 === n.Go.size && (r.ro() ? r.co() : ri(n) && 
...
function ni(t) {
    return ri(t) && !gi(t).io() && t.Go.size > 0;
}

function ri(t) {
    return 0 === m(t).zo.size;
}
...
function oi(e) {
    return t.__awaiter(this, void 0, void 0, (function() {
        return t.__generator(this, (function(t) {
            return e.Go.forEach((function(t, n) {
                $r(e, t);
            })), [ 2 /*return*/ ];
        }));
    }));
...
function ui(e, n, r) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(u) {
            switch (u.label) {
              case 0:
                if (e.Jo.set("Online" /* Online */), !(n instanceof Bt && 2 /* Removed */ === n.state && n.cause)) 
                    ...
                    return t.__awaiter(this, void 0, void 0, (function() {
                        ...
                        return t.__generator(this, (function(t) {
                            switch (t.label) {
                              ...
                              case 1:
                                return i < o.length ? (s = o[i], e.Go.has(s) ? [ 4 /*yield*/ , e.jo.Zo(s, r) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                              case 2:
                                t.sent(), e.Go.delete(s), e.Xo.removeTarget(s), t.label = 3;
              ...
              case 6:
                if (n instanceof jt ? e.Xo.Ve(n) : n instanceof qt ? e.Xo.$e(n) : e.Xo.Se(n), r.isEqual(ot.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;

              case 7:
                return u.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Lr(e.Bo) ];
              ...
              case 11:
                return l("RemoteStore", "Failed to raise snapshot:", s = u.sent()), [ 4 /*yield*/ , ai(e, s) ];
        ...
        return t.__generator(this, (function(o) {
            switch (o.label) {
              case 0:
                ...
                return e.zo.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Jr(e) ];

              case 1:
                // Disable network and raise offline snapshots
                return o.sent(), e.Jo.set("Offline" /* Offline */), r || (
                    ...
                    return t.__awaiter(i, void 0, void 0, (function() {
                        return t.__generator(this, (function(t) {
                            switch (t.label) {
                              ...
                              case 1:
                                return t.sent(), e.zo.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Hr(e) ];
...
function hi(e) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                n = m(e), r = mi(n), i = n.Wo.length > 0 ? n.Wo[n.Wo.length - 1].batchId : -1, t.label = 1;
 ...
 */ (n)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return t.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Ur(n.Bo, i) ];

              case 3:
                return null === (o = t.sent()) ? (0 === n.Wo.length && r.co(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.Wo.push(e);
                    var n = mi(t);
              ...
              case 4:
                return s = t.sent(), [ 4 /*yield*/ , ai(n, s) ];
...
function fi(t) {
    return ri(t) && !mi(t).io() && t.Wo.length > 0;
}
...
function di(e) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            ...
            for (n = mi(e), r = 0, i = e.Wo; r < i.length; r++) o = i[r], n.Vo(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function vi(e, n, r) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                return i = e.Wo.shift(), o = br.from(i, n, r), [ 4 /*yield*/ , ci(e, (function() {
                    return e.jo.eu(o);
                })) ];
...
function yi(e, n) {
    return t.__awaiter(this, void 0, void 0, (function() {
        return t.__generator(this, (function(r) {
            switch (r.label) {
              case 0:
                return n && mi(e).po ? [ 4 /*yield*/ , function(e, n) {
                    return t.__awaiter(this, void 0, void 0, (function() {
                        var r, i;
                        return t.__generator(this, (function(t) {
                            switch (t.label) {
                              case 0:
                                return gt(i = n.code) && i !== a.ABORTED ? (r = e.Wo.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                mi(e).uo(), [ 4 /*yield*/ , ci(e, (function() {
                                    return e.jo.nu(r.batchId, n);
                                })) ]) : [ 3 /*break*/ , 3 ];
 ...
 */ function gi(e) {
    ...
    e.su = function(t, e, n) {
        var r = m(t);
        return r.Do(), new Gr(e, r.Zr, r.credentials, r.serializer, n);
    }(e.Qo, e.xn, {
        Eo: oi.bind(null, e),
        fo: si.bind(null, e),
        Ao: ui.bind(null, e)
    }), e.Ko.push((function(r) {
        return t.__awaiter(n, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return r ? (e.su.uo(), ni(e) ? ei(e) : e.Jo.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , e.su.stop() ];

                  case 2:
                    t.sent(), ii(e), t.label = 3;
...
function mi(e) {
    ...
    e.iu = function(t, e, n) {
        var r = m(t);
        return r.Do(), new zr(e, r.Zr, r.credentials, r.serializer, n);
    }(e.Qo, e.xn, {
        Eo: pi.bind(null, e),
        fo: yi.bind(null, e),
        bo: di.bind(null, e),
        ...
        return t.__awaiter(n, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return r ? (e.iu.uo(), [ 4 /*yield*/ , hi(e) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    t.sent(), e.Wo.length > 0 && (l("RemoteStore", "Stopping write stream with " + e.Wo.length + " pending writes"), 
                    e.Wo = []), t.label = 4;
...
var wi = function(t) {
    ...
    e) {
        ...
        this.Qt = Ut(), this.cu = xn(t), this.au = new St(this.cu);
    }
    ...
    t.prototype.lu = function(t, e) {
        var n = this, r = e ? e._u : new Ot, i = e ? e.au : this.au, o = e ? e.Qt : this.Qt, s = i, u = !1, a = _n(this.query) && i.size === this.query.limit ? i.last() : null, c = In(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.at((function(t, e) {
            var h = i.get(t), f = e instanceof gn ? e : null;
            f && (f = On(n.query, f) ? f : null);
            ...
            o = o.delete(t)));
        })), _n(this.query) || In(this.query)) for (;s.size > this.query.limit; ) {
    ...
    t.prototype.wu = function(t, e, n) {
        ...
        return this.ou = u, 0 !== o.length || a ? {
            snapshot: new xt(this.query, t.au, i, o, t.Qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Eu: s
        } : {
            Eu: s
    ...
    t.prototype.mu = function(t) {
        ...
        // updating many documents.
                var e = this.uu;
        this.uu = Ut(), this.au.forEach((function(e) {
            t.Iu(e.key) && (t.uu = t.uu.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.uu.has(e) || n.push(new bi(e));
        })), this.uu.forEach((function(t) {
            e.has(t) || n.push(new wi(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.Ru = function() {
        return xt.Gt(this.query, this.au, this.Qt, 0 /* Local */ === this.ou);
    }, t;
}(), _i = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.vu = {}, this.bu = new rt((function(t) {
            return Pn(t);
        }), kn), this.Su = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Fu = new Map, this.Nu = new Or, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.$u = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ku = new Map, this.xu = Nr.Wi(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return t.__generator(this, (function(c) {
            switch (c.label) {
              case 0:
                return r = function(t) {
                    var e = m(t);
                    return e.Pu.jo.tu = Vi.bind(null, e), e.Pu.jo.qe = Fi.bind(null, e), e.Pu.jo.Zo = Ri.bind(null, e), 
                    e.vu.Ao = fr.bind(null, e.pu), e.vu.Lu = lr.bind(null, e.pu), e;
                }(e), (s = r.bu.get(n)) ? (
                ...
                i = s.targetId, r.gu.Gs(i), o = s.view.Ru(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];
             ...
             */
                function(t, e) {
                    ...
                    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
                        ...
                        return n.Zi.Pr(t, e).next((function(i) {
                            ...
                            r = i, er.resolve(r)) : n.Zi.qu(t).next((function(i) {
                                return r = new vt(e, i, 0 /* Listen */ , t.mr), n.Zi.Uu(t, r).next((function() {
                                    return r;
                                }));
                            }));
                        }));
              ...
              case 2:
                return u = c.sent(), a = r.gu.Gs(u.targetId), i = u.targetId, [ 4 /*yield*/ , 
                /**
                    ...
                    return t.__awaiter(this, void 0, void 0, (function() {
                        ...
                        return t.__generator(this, (function(f) {
                            switch (f.label) {
                                    ...
                                    return function(e, n, r, i) {
                                        return t.__awaiter(this, void 0, void 0, (function() {
                                            ...
                                            return t.__generator(this, (function(t) {
                                                switch (t.label) {
                                                  case 0:
                                                    return o = n.view.lu(r), o.du ? [ 4 /*yield*/ , Pr(e.Bo, n.query, 
                                                    /* usePreviousResults= */ !1).then((function(t) {
                                                        var e = t.documents;
                                                        return n.view.lu(e, o);
                                                    })) ] : [ 3 /*break*/ , 2 ];
                                                  ...
                                                  case 2:
                                                    return s = i && i.zt.get(n.targetId), u = n.view.wu(o, 
                                                    /* updateLimboDocuments= */ e.Mu, s), [ 2 /*return*/ , (Ci(e, n.targetId, u.Eu), 
                                                    u.snapshot) ];
                                                }
                                            }));
                                        }));
                              ...
                              case 1:
                                return o = f.sent(), s = new Ei(n, o.gr), u = s.lu(o.documents), a = Mt.Xt(r, i && "Offline" /* Offline */ !== e.onlineState), 
                                c = s.wu(u, 
                                /* updateLimboDocuments= */ e.Mu, a), Ci(e, r, c.Eu), h = new _i(n, r, s), e.bu.set(n, h), 
                                e.Su.has(r) ? e.Su.get(r).push(n) : e.Su.set(r, [ n ]), [ 2 /*return*/ , c.snapshot ];
                            }
                        }));
                    }));
                }(r, n, i, "current" === a) ];
              ...
              case 3:
                o = c.sent(), r.Mu && Xr(r.Pu, u), c.label = 4;
...
function Ni(e, n) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                return r = m(e), i = r.bu.get(n), (o = r.Su.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (r.Su.set(i.targetId, o.filter((function(t) {
                    return !kn(t, n);
                }))), void r.bu.delete(n)) ] : r.Mu ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                r.gu.Ks(i.targetId), r.gu.Xs(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , kr(r.Bo, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    r.gu.Ys(i.targetId), Zr(r.Pu, i.targetId), Oi(r, i.targetId);
                })).catch(Sr) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Oi(r, i.targetId), [ 4 /*yield*/ , kr(r.Bo, i.targetId, 
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                i = function(t) {
                    var e = m(t);
                    return e.Pu.jo.eu = Ui.bind(null, e), e.Pu.jo.nu = ki.bind(null, e), e;
                }(e), t.label = 1;
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.er.Ti(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], h = en(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new sn(c.key, h, vn(h.proto.mapValue), Ke.exists(!0)));
                            }
              ...
              case 2:
                return o = t.sent(), i.gu.js(o.batchId), function(t, e, n) {
                    var r = t.$u[t.currentUser.Cs()];
                    r || (r = new wt(H)), r = r.rt(e, n), t.$u[t.currentUser.Cs()] = r;
                }(i, o.batchId, r), [ 4 /*yield*/ , qi(i, o.ju) ];

              case 3:
                return t.sent(), [ 4 /*yield*/ , hi(i.Pu) ];

              case 4:
                return t.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = t.sent(), u = sr(s, "Failed to persist write"), r.reject(u), [ 3 /*break*/ , 6 ];
    ...
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              ...
              case 1:
                return t.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Rr(r.Bo, n) ];
              ...
              case 2:
                ...
                n.zt.forEach((function(t, e) {
                    ...
                    g(t.te.size + t.ee.size + t.ne.size <= 1), t.te.size > 0 ? n.yu = !0 : t.ee.size > 0 ? g(n.yu) : t.ne.size > 0 && (g(n.yu), 
                    n.yu = !1));
                })), [ 4 /*yield*/ , qi(r, i, n) ];
    ...
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (i = m(e)).gu.zs(n, "rejected", r), o = i.Fu.get(n), (s = o && o.key) ? (u = (u = new wt(N.i)).rt(s, new mn(s, ot.min())), 
                a = Ut().add(s), c = new Ct(ot.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new _t(H), u, a), [ 4 /*yield*/ , Vi(i, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                i.Du = i.Du.remove(s), i.Fu.delete(n), ji(i), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , kr(i.Bo, n, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Oi(i, n, r);
                })).catch(Sr) ];
    ...
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
              ...
              case 1:
                return t.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Vr(r.Bo, n) ];
              ...
              case 2:
                ...
                Si(r, i, /*error=*/ null), Pi(r, i), r.gu.Ws(i, "acknowledged"), [ 4 /*yield*/ , qi(r, o) ];
        ...
        return t.__generator(this, (function(t) {
            switch (t.label) {
                ...
                return t.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.hi.Wu(t, e).next((function(e) {
                            return g(null !== e), r = e.keys(), n.hi.hr(t, e);
                        })).next((function() {
                            return n.hi.lr(t);
                        })).next((function() {
                            return n.er.Ti(t, r);
              ...
              case 2:
                ...
                // listen events.
                Si(i, n, r), Pi(i, n), i.gu.Ws(n, "rejected", r), [ 4 /*yield*/ , qi(i, o) ];
...
function Si(t, e, n) {
    var r = m(t), i = r.$u[r.currentUser.Cs()];
...
function xi(t, e) {
    ...
    var n = t.Du.get(e);
    null !== n && (Zr(t.Pu, n), t.Du = t.Du.remove(e), t.Fu.delete(n), ji(t));
}

function Ci(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof wi ? (t.Nu.Cr(o.key, e), Mi(t, o)) : o instanceof bi ? (l("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function Mi(t, e) {
    var n = e.key;
    t.Du.get(n) || (l("SyncEngine", "New document in limbo: " + n), t.Cu.push(n), ji(t));
}
 ...
 */ function ji(t) {
    for (;t.Cu.length > 0 && t.Du.size < t.Vu; ) {
        ...
        t.Fu.set(n, new Ii(e)), t.Du = t.Du.rt(e, n), Xr(t.Pu, new vt(Vn(En(e.path)), n, 2 /* LimboResolution */ , yr.Os));
    }
}
...
function qi(e, n, r) {
    return t.__awaiter(this, void 0, void 0, (function() {
        ...
        return t.__generator(this, (function(a) {
            switch (a.label) {
              case 0:
                return i = m(e), o = [], s = [], u = [], i.bu.m() ? [ 3 /*break*/ , 3 ] : (i.bu.forEach((function(t, e) {
                    u.push(i.Bu(e, n, r).then((function(t) {
                        if (t) {
                            i.Mu && i.gu.zs(e.targetId, t.fromCache ? "not-current" : "current"), o.push(t);
                            var n = _r.Si(e.targetId, t);
                            s.push(n);
                        }
                    })));
              ...
              case 1:
                return a.sent(), i.vu.Ao(o), [ 4 /*yield*/ , function(e, n) {
                    return t.__awaiter(this, void 0, void 0, (function() {
                            ...
                            switch (t.label) {
                              ...
                              case 1:
                                return t.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , r.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return er.forEach(n, (function(e) {
                                        return er.forEach(e.vi, (function(n) {
                                            return r.persistence.Ar.Cr(t, e.targetId, n);
                                        })).next((function() {
                                            return er.forEach(e.bi, (function(n) {
                                                return r.persistence.Ar.Fr(t, e.targetId, n);
                                            }));
                                        }));
                                    }));
                                })) ];
                              ...
                              case 4:
                                for (o = 0, s = n; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = r.zi.get(a), 
                                h = c.et, f = c.it(h), 
        ...
        return t.__generator(this, (function(o) {
            switch (o.label) {
                ...
                function(e, n) {
                    return t.__awaiter(this, void 0, void 0, (function() {
                        ...
                        return t.__generator(this, (function(t) {
                            switch (t.label) {
                              case 0:
                                return r = m(e), i = r.hi, o = r.er, [ 4 /*yield*/ , r.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                                    // Swap out the mutation queue, grabbing the pending mutation batches
                                    // before and after.
                                    var e;
                                    return r.hi.zu(t).next((function(s) {
                                        return e = s, i = r.persistence.Yi(n), 
                                        // Recreate our LocalDocumentsView using the new
                                        // MutationQueue.
                                        o = new Er(r.Ji, i, r.persistence.nr()), i.zu(t);
                                    })).next((function(n) {
                              ...
                              case 1:
                                return s = t.sent(), [ 2 /*return*/ , (r.hi = i, r.er = o, r.Gi.sr(r.er), s) ];
                            }
                        }));
                    }));
                }(r.Bo, n) ]);
              ...
              case 1:
                ...
                r.gu.Zs(n, i.Hu, i.Yu), [ 4 /*yield*/ , qi(r, i.Ku) ];
...
function Fi(t, e) {
    var n = m(t), r = n.Fu.get(e);
    if (r && r.yu) return Ut().add(r.key);
    var i = Ut(), o = n.Su.get(e);
    if (!o) return i;
...
var Gi = /** @class */ function() {
    ...
    return t.prototype.sr = function(t) {
        this.Ju = t;
    }, t.prototype.Ai = function(t, e, r, i) {
        var o = this;
        ...
        }(e) || r.isEqual(ot.min()) ? this.Xu(t, e) : this.Ju.Ti(t, i).next((function(s) {
            var u = o.Zu(e, s);
            return (_n(e) || In(e)) && o.du(e.on, u, i, r) ? o.Xu(t, e) : (f() <= n.LogLevel.DEBUG && l("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), Sn(e)), 
            o.Ju.Ai(t, e, r).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Zu = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof gn && On(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.du = function(t, e, n, r) {
        ...
        return f() <= n.LogLevel.DEBUG && l("IndexFreeQueryEngine", "Using full collection scan to execute query:", Sn(e)), 
        this.Ju.Ai(t, e, ot.min());
    }, t;
}(), zi = /** @class */ function() {
    function t(t, e) {
        this.li = t, this.Ar = e, 
        ...
        this.ec = new _t(xr.vr);
    }
    return t.prototype.nc = function(t) {
        return er.resolve(0 === this.hi.length);
    }, t.prototype.Qu = function(t, e, n, r) {
        var i = this.tc;
        this.tc++, this.hi.length > 0 && this.hi[this.hi.length - 1];
        var o = new wr(i, e, n, r);
        this.hi.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.ec = this.ec.add(new xr(a.key, i)), this.li.Bi(t, a.key.path.h());
        }
        return er.resolve(o);
    }, t.prototype.Wu = function(t, e) {
        return er.resolve(this.sc(e));
    }, t.prototype.yr = function(t, e) {
        var n = e + 1, r = this.ic(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return er.resolve(this.hi.length > i ? this.hi[i] : null);
    }, t.prototype.Gu = function() {
        return er.resolve(0 === this.hi.length ? -1 : this.tc - 1);
    }, t.prototype.zu = function(t) {
        return er.resolve(this.hi.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                N.N(i) || (i = i.child(""));
        var o = new xr(new N(i), 0), s = new _t(H);
        ...
        var n = this;
        g(0 === this.oc(e.batchId, "removed")), this.hi.shift();
        var r = this.ec;
        ...
        var n = new xr(e, 0), r = this.ec.$t(n);
        return er.resolve(e.isEqual(r && r.key));
    }, t.prototype.lr = function(t) {
        return this.hi.length, er.resolve();
    }, 
    /**
    ...
    t.prototype.Er = function(t) {
        ...
        for (var r = Vt(), i = new N(e.path.child("")), o = this.docs._t(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.It(); ) {
            var s = o.Et(), u = s.key, a = s.value, c = a.hc, h = a.readTime;
            if (!e.path.T(u.path)) break;
            h.L(n) <= 0 || c instanceof gn && On(e, c) && (r = r.rt(c.key, c));
        }
        return er.resolve(r);
 ...
 */
Qi._c = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Ic = t, n;
    }
    return t.__extends(n, e), n.prototype.wu = function(t) {
        var e = this, n = [];
    ...
    t.prototype.wi = function(t, e) {
        this.mc();
        var n = this.ju.get(e);
        return void 0 !== n ? er.resolve(n) : this.Tc(t, e);
    }, 
    /**
...
var Wi = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.yc = new Or, this.targetCount = 0, this.Pc = Nr.ji();
    }
    return t.prototype.Ce = function(t, e) {
        ...
        return er.resolve(this.Rc);
    }, t.prototype.qu = function(t) {
        return this.highestTargetId = this.Pc.next(), er.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Pc = new Nr(e), this.highestTargetId = e), t.sequenceNumber > this.Rc && (this.Rc = t.sequenceNumber);
    }, t.prototype.Uu = function(t, e) {
        return this.Vc(e), this.targetCount += 1, er.resolve();
    }, t.prototype.Tr = function(t, e) {
        return this.Vc(e), er.resolve();
        ...
        return this.yc.Dr(e, n), er.resolve();
        ...
        return this.yc.kr(e), er.resolve();
    }, t.prototype.pr = function(t, e) {
        var n = this.yc.Mr(e);
        return er.resolve(n);
    }, t.prototype.Lr = function(t, e) {
        return er.resolve(this.yc.Lr(e));
    }, t;
}(), Yi = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Dc = {}, this.Fc = new yr(0), this.Nc = !1, this.Nc = !0, this.Ar = t(this), 
        this.Zi = new Wi(this), this.li = new Ar, this.ai = new Qi(this.li, (function(t) {
            return e.Ar.$c(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Dc[t.Cs()];
        return e || (e = new zi(this.li, this.Ar), this.Dc[t.Cs()] = e), e;
        ...
        return er.kn(Object.values(this.Dc).map((function(n) {
            return function() {
                return n.Lr(t, e);
            };
        })));
    ...
    return t.Gc = function(e) {
        ...
        return this.jc.Cr(n, e), this.zc.delete(n.toString()), er.resolve();
    }, t.prototype.Fr = function(t, e, n) {
        return this.jc.Fr(n, e), this.zc.add(n.toString()), er.resolve();
    }, t.prototype.uc = function(t, e) {
        return this.zc.add(e.toString()), er.resolve();
        ...
        // Remove newly orphaned documents.
                return er.forEach(this.zc, (function(r) {
            var i = N.C(r);
        ...
        var n = this;
        return er.kn([ function() {
            return er.resolve(n.jc.Lr(e));
        }, function() {
    ...
    return t.__extends(n, e), n.prototype.ca = function(t, e, n, r) {
        ...
        var h = o.createWebChannel(u, s), f = !1, p = !1, v = new Ki({
            Hc: function(t) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var no = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", ro = /** @class */ function() {
    function e() {}
    return e.prototype.initialize = function(e) {
        return t.__awaiter(this, void 0, void 0, (function() {
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.gu = this.ma(e), this.persistence = this.Ta(e), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return t.sent(), this.Ea = this.Ia(e), this.Bo = this.Aa(e), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new Gi, r = t.Ra, new Dr(e, n, r);
        var e, n, r;
    }, e.prototype.Ta = function(t) {
        if (t.persistenceSettings.ya) throw new c(a.FAILED_PRECONDITION, no);
        return new Yi(Ji.Gc);
        ...
        throw new c(a.FAILED_PRECONDITION, no);
    }, e;
}(), io = /** @class */ function() {
    function e() {}
    return e.prototype.initialize = function(e, n) {
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.Bo ? [ 3 /*break*/ , 2 ] : (this.Bo = e.Bo, this.gu = e.gu, this.Qo = this.Pa(n), 
                    this.Pu = this.pa(n), this.pu = this.ga(n), this.Va = this.va(n), this.gu.Qs = function(t) {
                        return Li(r.Va, t, 1 /* SharedClientState */);
                    }, this.Pu.jo.ba = Bi.bind(null, this.Va), [ 4 /*yield*/ , 
                    /**
                    ...
                    function(e, n) {
                        return t.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return t.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return r = m(e), n ? (r.zo.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Hr(r) ]) : [ 3 /*break*/ , 2 ];

                                  case 1:
                                    return t.sent(), [ 3 /*break*/ , 5 ];

                                  case 2:
                                    return (i = n) ? [ 3 /*break*/ , 4 ] : (r.zo.add(2 /* IsSecondary */), [ 4 /*yield*/ , Jr(r) ]);

                                  case 3:
                                    t.sent(), i = r.Jo.set("Unknown" /* Unknown */), t.label = 4;
        ...
        var e, n = eo(t.sa.B), r = (e = t.sa, new Zi(e));
        ...
        return e = this.Bo, n = this.Qo, r = t.xn, i = function(t) {
            return Li(s.Va, t, 0 /* RemoteStore */);
        }, o = $i.wa() ? new $i : new to, new Yr(e, n, r, i, o);
    }, e.prototype.va = function(t) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new Ai(t, e, n, r, i, o);
            return s && (u.Ou = !0), u;
    ...
    return t.__extends(n, e), n.documentId = function() {
        ...
        if (!(t instanceof n)) throw F("isEqual", "FieldPath", 1, t);
...
var lo = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t.__extends(n, e), n.prototype.Na = function(t) {
        return new He(t.path, new je);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(co), po = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(co), yo = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).La = n, r;
    }
    return t.__extends(n, e), n.prototype.Na = function(t) {
        var e = new ze(t.serializer, ve(t.serializer, this.La));
        return new He(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(co), go = /** @class */ function() {
    /**
     ...
     */
    t.prototype.H = function(t) {
        return H(this.qa, t.qa) || H(this.Ua, t.Ua);
    }, t;
}(), mo = function(t) {
    this.Ba = t;
}, wo = /^__.*__$/, bo = function(t, e, n) {
    ...
    return t.prototype.Ga = function(t, e) {
        var n = [];
        return null !== this.Qe ? n.push(new sn(t, this.data, this.Qe, e)) : n.push(new on(t, this.data, e)), 
    ...
    return t.prototype.Ga = function(t, e) {
        var n = [ new sn(t, this.data, this.Qe, e) ];
...
/** A "context" object passed around while parsing user data. */ var Ao = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Ka = function(e) {
        ...
        return xo(t, this.settings.methodName, this.settings.Za || !1, this.path, this.settings.xa);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Io(this.$a) && wo.test(t)) throw this.ka('Document fields cannot begin and end with "__"');
    }, t;
}(), To = /** @class */ function() {
    function t(t, e, n) {
        this.B = t, this.ignoreUndefinedProperties = e, this.serializer = n || eo(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.th = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Ao({
            $a: t,
            methodName: e,
            xa: n,
            path: T.p(),
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function No(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.th(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Po("Data must be an object, but it was:", s, r);
    var u, h, f = Uo(r, s);
    if (o.merge) u = new Ye(s.Qe), h = s.fieldTransforms; else if (o.mergeFields) {
        for (var l = [], p = 0, d = o.mergeFields; p < d.length; p++) {
            var v = d[p], g = void 0;
            if (v instanceof so) g = v.Da; else {
        ...
        u = new Ye(l), h = s.fieldTransforms.filter((function(t) {
            return u.Ke(t.field);
        }));
    } else u = null, h = s.fieldTransforms;
    return new Eo(new pn(f), u, h);
}

/** Parse update data from an update() call. */ function Do(t, e, n, r) {
    var i = t.th(1 /* Update */ , e, n);
    Po("Data must be an object, but it was:", i, r);
    var o = [], s = new dn;
    b(r, (function(t, r) {
        var u = Oo(e, t, n), a = i.Ja(u);
        if (r instanceof ho || r instanceof mo && r.Ba instanceof ho) 
...
/** Parse update data from a list of field/value arguments. */ function Vo(t, e, n, r, i, o) {
    ...
    for (var f = 0; f < o.length; f += 2) u.push(So(e, o[f])), h.push(o[f + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], p = new dn, d = u.length - 1; d >= 0; --d) if (!Co(l, u[d])) {
        var v = u[d], y = h[d], g = s.Ja(v);
        if (y instanceof ho || y instanceof mo && y.Ba instanceof ho) 
        // Add it to the field mask, but don't add anything to updateData.
        l.push(v); else {
            var m = Ro(y, g);
    ...
    var w = new Ye(l);
    return new _o(p.Je(), w, s.fieldTransforms);
}
 ...
 */ function Lo(t, e, n, r) {
    return void 0 === r && (r = !1), Ro(n, t.th(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ro(t, e) {
    ...
    // from firestore-exp.
    t instanceof mo && (t = t.Ba), ko(t)) return Po("Unsupported field value:", e, t), 
    Uo(t, e);
    if (t instanceof co) 
    ...
    return function(t, e) {
        ...
        if (!Io(e.$a)) throw e.ka(t.Fa + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof X) return {
            bytesValue: ge(e.serializer, t.U)
        };
        if (t instanceof bo) {
            var i = e.B, o = t.Qa;
            ...
            return {
                referenceValue: be(t.Qa || e.B, t.ja.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.ka("Unsupported field value: " + j(t));
    }(t, e);
}
...
function ko(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof it || t instanceof go || t instanceof X || t instanceof bo || t instanceof co);
}
 ...
 */ function So(t, e, n) {
    if (e instanceof so) return e.Da;
 ...
 */ function Oo(e, n, r) {
    try {
        return function(e) {
            if (e.search(ao) >= 0) throw new c(a.INVALID_ARGUMENT, "Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (uo.bind.apply(uo, t.__spreadArrays([ void 0 ], e.split("."))));
            } catch (t) {
 ...
 */ var Mo = /** @class */ function() {
    ...
    return e.prototype.rh = function(e) {
                ...
                switch (i.label) {
                    ...
                    return [ 4 /*yield*/ , function(e, n) {
                        return t.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return t.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return r = m(e), i = Ae(r.serializer) + "/documents", o = {
                                        documents: n.map((function(t) {
                                            return Ee(r.serializer, t);
                                        }))
                                    }, [ 4 /*yield*/ , r.No("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = t.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = _e(t, e.found.name), r = we(e.found.updateTime), i = new pn({
                                                    mapValue: {
                                                ...
                                                var n = _e(t, e.missing), r = we(e.readTime);
                                                return new mn(n, r);
                                            }(t, e) : y();
                                        }(r.serializer, t);
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof mn || t instanceof gn ? r.uh(t) : y();
                    })), n) ];
                }
            }));
        }));
        ...
        this.write([ new fn(t, this.Ge(t)) ]), this.ih.add(t.toString());
                ...
                switch (r.label) {
                  case 0:
                    ...
                    e.forEach((function(t, e) {
                        var r = N.C(e);
                        n.mutations.push(new ln(r, n.Ge(r)));
    ...
    e.prototype.Ge = function(t) {
        ...
        return !this.ih.has(t.toString()) && e ? Ke.updateTime(e) : Ke.He();
    }, 
    /**
    ...
    function e(t, e, n, r) {
        this.xn = t, this.Qo = e, this.updateFunction = n, this.Ln = r, this.hh = 5, this.Jn = new tr(this.xn, "transaction_retry" /* TransactionRetry */)
    ...
    return e.prototype.run = function() {
        ...
        this.Jn.Rn((function() {
            return t.__awaiter(e, void 0, void 0, (function() {
                var e, n, r = this;
                return t.__generator(this, (function(t) {
                    return e = new Mo(this.Qo), (n = this._h(e)) && n.then((function(t) {
                        r.xn.Qn((function() {
        ...
        try {
            ...
            return !st(e) && e.catch && e.then ? e : (this.Ln.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
     ...
     */
    e) {
        this.credentials = t, this.xn = e, this.clientId = Y.k(), 
    ...
    return e.prototype.start = function(e, n, r, i) {
        ...
        return this.credentials.jr((function(e) {
                ...
                return function(e, n) {
                    return t.__awaiter(this, void 0, void 0, (function() {
                        ...
                        return t.__generator(this, (function(t) {
                            switch (t.label) {
                              case 0:
                                return (r = m(e)).xn.cs(), l("RemoteStore", "RemoteStore received new credentials"), 
                                i = ri(r), 
                                // Tear down and re-create our network streams. This will ensure we get a
                                // fresh auth token for the new user and re-fill the write pipeline with
                                // new mutations from the LocalStore (since mutations are per-user).
                                r.zo.add(3 /* CredentialChange */), [ 4 /*yield*/ , Jr(r) ];

                              case 1:
                                return t.sent(), i && 
                                // Don't set the network status to Unknown if we are offline.
                                r.Jo.set("Unknown" /* Unknown */), [ 4 /*yield*/ , r.jo.ba(n) ];

                              case 2:
                                return t.sent(), r.zo.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Hr(r) ];
    ...
    /** Enables the network connection and requeues all pending operations. */ e.prototype.enableNetwork = function() {
        ...
        return this.mh(), this.xn.enqueue((function() {
            return t.persistence.Oc(!0), function(t) {
                var e = m(t);
                return e.zo.delete(0 /* UserDisabled */), Hr(e);
            }(t.Pu);
        }));
    }, 
    /**
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(c) {
                switch (c.label) {
                  ...
                  case 2:
                    return c.sent(), this.persistence = e.persistence, this.gu = e.gu, this.Bo = e.Bo, 
                    this.Ea = e.Ea, this.Qo = n.Qo, this.Pu = n.Pu, this.Va = n.Va, this.Eh = n.pu, 
                    this.Eh.Es = Ti.bind(null, this.Va), this.Eh.Rs = Ni.bind(null, this.Va), 
    ...
    e.prototype.mh = function() {
        if (this.xn.Zn) throw new c(a.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
            ...
            return e.persistence.Oc(!1), function(e) {
                return t.__awaiter(this, void 0, void 0, (function() {
                    ...
                    return t.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return (n = m(e)).zo.add(0 /* UserDisabled */), [ 4 /*yield*/ , Jr(n) ];

                          case 1:
                            return t.sent(), 
                            // Set the OnlineState to Offline so get()s return from cache, etc.
                            n.Jo.set("Offline" /* Offline */), [ 2 /*return*/ ];
                        }
                    }));
                }));
            }(e.Pu);
                ...
                return t.__generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        ...
                        this.Ea && this.Ea.stop(), [ 4 /*yield*/ , Kr(this.Pu) ];

                      case 1:
                        return t.sent(), [ 4 /*yield*/ , this.gu.ei() ];
                      ...
                      case 3:
                        ...
                        // auth tokens.
                        this.credentials.Wr(), n.resolve(), [ 3 /*break*/ , 5 ];

                      case 4:
                        return e = t.sent(), r = sr(e, "Failed to shutdown persistence"), n.reject(r), [ 3 /*break*/ , 5 ];
            ...
            return function(e, n) {
                return t.__awaiter(this, void 0, void 0, (function() {
                    ...
                    return t.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            ri((r = m(e)).Pu) || l("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                            t.label = 1;
                          ...
                          case 3:
                            return s = t.sent(), u = sr(s, "Initialization of waitForPendingWrites() operation failed"), 
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    return i.sent(), n = new $n, [ 2 /*return*/ , (this.xn.Qn((function() {
                            ...
                            return t.__awaiter(this, void 0, void 0, (function() {
                                ...
                                return t.__generator(this, (function(t) {
                                    switch (t.label) {
                                      ...
                                      case 1:
                                        return (i = t.sent()) instanceof gn ? r.resolve(i) : i instanceof mn ? r.resolve(null) : r.reject(new c(a.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = t.sent(), s = sr(o, "Failed to get document '" + n + " from cache"), 
        ...
        return void 0 === n && (n = {}), t.__awaiter(this, void 0, void 0, (function() {
            ...
            return t.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), r = new $n, [ 2 /*return*/ , (this.xn.Qn((function() {
                        ...
                        return function(e, n, r) {
                            return t.__awaiter(this, void 0, void 0, (function() {
                                ...
                                return t.__generator(this, (function(t) {
                                    switch (t.label) {
                                      case 0:
                                        return t.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Pr(e, n, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return i = t.sent(), o = new Ei(n, i.gr), s = o.lu(i.documents), u = o.wu(s, 
                                        /* updateLimboDocuments= */ !1), r.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = t.sent(), c = sr(a, "Failed to execute query '" + n + " against cache"), 
    ...
    }, Object.defineProperty(e.prototype, "gh", {
        get: function() {
    ...
    e.prototype.transaction = function(t) {
        ...
        var n = new $n;
        return this.xn.Qn((function() {
            return new jo(e.xn, e.Qo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, e;
}();
...
var Fo = /** @class */ function() {
    ...
    return t.prototype.Ch = function(t) {
        switch (Jt(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.Sh(re(t.bytesValue));
        ...
        return new go(ne(t.latitude), ne(t.longitude));
        ...
        var e = ee(t), n = new it(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.Nh = function(t) {
        var e = I.P(t);
        g(Se(e));
        var n = new nt(e.get(1), e.get(3)), r = new N(e.u(5));
...
}(), Go = Ir.xi, zo = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new c(a.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else P("settings", "non-empty string", "host", t.host), this.host = t.host, S("settings", "boolean", "ssl", t.ssl), 
        ...
        S("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        S("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), S("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        S("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Ir.Mi; else {
            if (t.cacheSizeBytes !== Go && t.cacheSizeBytes < Ir.Oi) throw new c(a.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Ir.Oi);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        S("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function e(n, r, i, o) {
        var s = this;
        if (void 0 === i && (i = new ro), void 0 === o && (o = new io), this.Oh = i, this.Mh = o, 
        this.Lh = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.qh = new or, this.INTERNAL = {
            delete: function() {
                return t.__awaiter(s, void 0, void 0, (function() {
                    return t.__generator(this, (function(t) {
                        switch (t.label) {
    ...
    return Object.defineProperty(e.prototype, "zh", {
        get: function() {
            ...
            this.Kh = new To(this.Qa, this.Gh.ignoreUndefinedProperties)), this.Kh;
        },
        enumerable: !1,
        configurable: !0
        ...
        return t.__awaiter(this, void 0, void 0, (function() {
            var e, n = this;
            return t.__generator(this, (function(r) {
                if (void 0 !== this.Bh && !this.Bh.gh) throw new c(a.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return e = new $n, [ 2 /*return*/ , (this.qh.ts((function() {
                    return t.__awaiter(n, void 0, void 0, (function() {
                        var n;
                        return t.__generator(this, (function(t) {
                            switch (t.label) {
        ...
        if (this.Uh(), Bo(t)) return this.Bh.ph(t);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Hh(new ro, new io, {
            ya: !1
        }), this.Bh;
    }, e.prototype.Xh = function() {
        return new et(this.Qa, this.jh, this.Gh.host, this.Gh.ssl, this.Gh.experimentalForceLongPolling);
    }, e.prototype.Hh = function(t, e, n) {
        var r = this.Xh();
        return this.Bh = new qo(this.Wh, this.qh), this.Bh.start(r, t, e, n);
    }, e.Qh = function(t) {
        ...
        get: function() {
            if (!this.Lh) throw new c(a.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Lh;
        },
        enumerable: !1,
        configurable: !0
 ...
 */
        ...
        var e;
        V("Firestore.setLogLevel", arguments, 1), x("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, h.setLogLevel(e);
    }, 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = hs("Transaction.get", t, this.nl);
        return this.sl.rh([ n.ja ]).then((function(t) {
            if (!t || 1 !== t.length) return y();
            var r = t[0];
            if (r instanceof mn) return new Ko(e.nl, n.ja, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Wa);
            if (r instanceof gn) return new Ko(e.nl, n.ja, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Wa);
            throw y();
        }));
        ...
        var r = hs("Transaction.set", t, this.nl);
        n = us("Transaction.set", n);
        var i = ls(r.Wa, e, n), o = No(this.nl.zh, "Transaction.set", r.ja, i, null !== r.Wa, n);
        return this.sl.set(r.ja, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof uo ? (L("Transaction.update", arguments, 3), 
        r = hs("Transaction.update", t, this.nl), i = Vo(this.nl.zh, "Transaction.update", r.ja, e, n, o)) : (V("Transaction.update", arguments, 2), 
        r = hs("Transaction.update", t, this.nl), i = Do(this.nl.zh, "Transaction.update", r.ja, e)), 
        this.sl.update(r.ja, i), this;
    }, t.prototype.delete = function(t) {
        V("Transaction.delete", arguments, 1);
        var e = hs("Transaction.delete", t, this.nl);
    ...
    return t.prototype.set = function(t, e, n) {
        R("WriteBatch.set", arguments, 2, 3), this.ol();
        var r = hs("WriteBatch.set", t, this.nl);
        n = us("WriteBatch.set", n);
        var i = ls(r.Wa, e, n), o = No(this.nl.zh, "WriteBatch.set", r.ja, i, null !== r.Wa, n);
        return this.il = this.il.concat(o.Ga(r.ja, Ke.He())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.ol(), "string" == typeof e || e instanceof uo ? (L("WriteBatch.update", arguments, 3), 
        r = hs("WriteBatch.update", t, this.nl), i = Vo(this.nl.zh, "WriteBatch.update", r.ja, e, n, o)) : (V("WriteBatch.update", arguments, 2), 
        r = hs("WriteBatch.update", t, this.nl), i = Do(this.nl.zh, "WriteBatch.update", r.ja, e)), 
        this.il = this.il.concat(i.Ga(r.ja, Ke.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        V("WriteBatch.delete", arguments, 1), this.ol();
        var e = hs("WriteBatch.delete", t, this.nl);
        return this.il = this.il.concat(new fn(e.ja, Ke.He())), this;
    ...
    return t.__extends(n, e), n.Zh = function(t, e, r) {
        ...
        get: function() {
            return new ss(this.ja.path.h(), this.firestore, this.Wa);
        },
        enumerable: !1,
        configurable: !0
        ...
        var e = I.P(t);
        return new ss(this.ja.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw F("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.ja.isEqual(t.ja) && this.Wa === t.Wa;
    }, n.prototype.set = function(t, e) {
        R("DocumentReference.set", arguments, 1, 2), e = us("DocumentReference.set", e);
        var n = ls(this.Wa, t, e), r = No(this.firestore.zh, "DocumentReference.set", this.ja, n, null !== this.Wa, e);
        return this.Bh.write(r.Ga(this.ja, Ke.He()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof uo ? (L("DocumentReference.update", arguments, 2), 
        n = Vo(this.firestore.zh, "DocumentReference.update", this.ja, t, e, r)) : (V("DocumentReference.update", arguments, 1), 
        n = Do(this.firestore.zh, "DocumentReference.update", this.ja, t)), this.Bh.write(n.Ga(this.ja, Ke.exists(!0)));
    }, n.prototype.delete = function() {
        return V("DocumentReference.delete", arguments, 0), this.Bh.write([ new fn(this.ja, Ke.He()) ]);
        ...
        "object" != typeof i[u] || Bo(i[u]) || (B("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        S("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++);
        var a = {
        ...
        } else U("DocumentReference.onSnapshot", "function", u, i[u]), k("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        k("DocumentReference.onSnapshot", "function", u + 2, i[u + 2]);
        var h = {
            next: function(t) {
                i[u] && i[u](r.ul(t));
            },
        ...
        return this.Bh.listen(En(this.ja.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        R("DocumentReference.get", arguments, 0, 1), cs("DocumentReference.get", t);
        var n = this.firestore.Uh();
        return t && "cache" === t.source ? n.Ah(this.ja).then((function(t) {
            return new Ko(e.firestore, e.ja, t, 
            /*fromCache=*/ !0, t instanceof gn && t.Ye, e.Wa);
    ...
    n.prototype.ul = function(t) {
        ...
        return new Ko(this.firestore, this.ja, e, t.fromCache, t.hasPendingWrites, this.Wa);
    }, n;
}(bo), Jo = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (R("DocumentSnapshot.data", arguments, 0, 1), t = as("DocumentSnapshot.data", t), 
        this.cl) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Wa) {
                var n = new Xo(this.nl, this.ja, this.cl, this.al, this.hl, 
                /* converter= */ null);
                return this.Wa.fromFirestore(n, t);
            }
            return new Fo(this.nl.Qa, this.nl.tl(), t.serverTimestamps || "none", (function(t) {
                return new Ho(t, e.nl, /* converter= */ null);
            }), (function(t) {
                return new tt(t);
            })).Ch(this.cl.sn());
        }
        ...
        var n = this;
        if (R("DocumentSnapshot.get", arguments, 1, 2), e = as("DocumentSnapshot.get", e), 
        this.cl) {
            var r = this.cl.data().field(So("DocumentSnapshot.get", t, this.ja));
            if (null !== r) return new Fo(this.nl.Qa, this.nl.tl(), e.serverTimestamps || "none", (function(t) {
                return new Ho(t, n.nl, n.Wa);
            }), (function(t) {
                return new tt(t);
            })).Ch(r);
        }
        ...
        get: function() {
            return new Ho(this.ja, this.nl, this.Wa);
        },
        enumerable: !1,
        configurable: !0
        ...
        get: function() {
            return new Jo(this.hl, this.al);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw F("isEqual", "DocumentSnapshot", 1, e);
...
function Zo(t, e, n, r, i, o, s) {
    ...
    } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || es(s, o), 
    u = Lo(n, e, s, 
    /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
    var d = Cn.create(i, o, u);
    return function(t, e) {
        if (e.an()) {
            var n = Tn(t);
...
function ts(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!Nn(e) && -1 !== n.indexOf("/")) throw new c(a.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(I.P(n));
        if (!N.N(r)) throw new c(a.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return ie(t, new N(r));
    }
    if (n instanceof bo) return ie(t, n.ja);
    throw new c(a.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + j(n) + ".");
}
...
function rs(t) {
    if (In(t) && 0 === t.rn.length) throw new c(a.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var is = /** @class */ function() {
    ...
    return e.prototype.where = function(t, n, r) {
        ...
        var i = x("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , "!=" /* NOT_EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ , "not-in" /* NOT_IN */ ], 2, n), o = So("Query.where", t), s = Zo(this.ll, "Query.where", this.firestore.zh, this.firestore.Qa, o, i, r);
        ...
        var r;
        if (R("Query.orderBy", arguments, 1, 2), k("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = So("Query.orderBy", t), o = $o(this.ll, i, r);
        return new e(function(t, e) {
        ...
        /*before=*/ !0);
        return new e(Un(this.ll, i), this.firestore, this.Wa);
        ...
        if (!(t instanceof e)) throw F("isEqual", "Query", 1, t);
    ...
    /** Helper function to create a bound from a document or fields */ e.prototype._l = function(e, n, r, i) {
        if (q(e, 1, n), n instanceof Ko) return V(e, t.__spreadArrays([ n ], r), 1), function(t, e, n, r, i) {
            ...
            // results.
            for (var o = [], s = 0, u = Dn(t); s < u.length; s++) {
                var h = u[s];
                if (h.field.V()) o.push(ie(e, r.key)); else {
                    var f = r.field(h.field);
                    if (Wt(f)) throw new c(a.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + h.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === f) {
                        var l = h.field.R();
        ...
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], h = 0; h < i.length; h++) {
                ...
                if (s[h].field.V()) {
                    ...
                    if (!Nn(t) && -1 !== f.indexOf("/")) throw new c(a.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + f + "' contains a slash.");
                    var l = t.path.child(I.P(f));
                    if (!N.N(l)) throw new c(a.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + l + "' is not because it contains an odd number of segments.");
                    var p = new N(l);
                    u.push(ie(e, p));
                } else {
                    var d = Lo(n, r, f);
        ...
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Bo(i[u]) || (B("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        S("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++), Bo(i[u])) {
            var a = i[u];
        ...
        } else U("Query.onSnapshot", "function", u, i[u]), k("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        k("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new os(r.firestore, r.ll, t, r.Wa));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return rs(this.ll), this.firestore.Uh().listen(this.ll, s, c);
    }, e.prototype.get = function(t) {
        var e = this;
        R("Query.get", arguments, 0, 1), cs("Query.get", t), rs(this.ll);
        var n = this.firestore.Uh();
        return (t && "cache" === t.source ? n.yh(this.ll) : n.Ph(this.ll, t)).then((function(t) {
            return new os(e.firestore, e.ll, t, e.Wa);
        }));
    }, e;
}(), os = /** @class */ function() {
    function t(t, e, n, r) {
        this.nl = t, this.fl = e, this.dl = n, this.Wa = r, this.wl = null, this.ml = null, 
        this.metadata = new Jo(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        R("QuerySnapshot.forEach", arguments, 1, 2), U("QuerySnapshot.forEach", "function", 1, t), 
        this.dl.docs.forEach((function(r) {
            t.call(e, n.Tl(r, n.metadata.fromCache, n.dl.Qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new is(this.fl, this.nl, this.Wa);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (B("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), S("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.dl.Wt) throw new c(a.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw F("isEqual", "QuerySnapshot", 1, e);
        return this.nl === e.nl && kn(this.fl, e.fl) && this.dl.isEqual(e.dl) && this.Wa === e.Wa;
    }, t.prototype.Tl = function(t, e, n) {
        return new Xo(this.nl, t.key, t, e, n, this.Wa);
    }, t;
}(), ss = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, En(t), n, r) || this).El = t, t.length % 2 != 1) throw new c(a.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.R() + " has " + t.length);
        return i;
    }
    return t.__extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.m() ? null : new Ho(new N(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = Y.k()), U("CollectionReference.doc", "non-empty string", 1, t);
        var e = I.P(t);
        return Ho.Zh(this.ll.path.child(e), this.firestore, this.Wa);
        ...
        // Call set() with the converted value directly to avoid calling toFirestore() a second time.
                return new Ho(n.ja, this.firestore, null).set(e).then((function() {
            return n;
        }));
    }, n.prototype.withConverter = function(t) {
...
function us(t, e) {
    ...
    if (B(t, e, [ "merge", "mergeFields" ]), S(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new c(a.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + j(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new c(a.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + j(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof uo;
...
function as(t, e) {
    return void 0 === e ? {} : (B(t, e, [ "serverTimestamps" ]), O(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function cs(t, e) {
    k(t, "object", 1, e), e && (B(t, e, [ "source" ]), O(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function hs(t, e, n) {
    ...
    throw F(t, "DocumentReference", 1, e);
}
 ...
 */
        function() {
            ...
            // update() since we'd need the Firestore instance to do this.
                        return L("arrayUnion()", arguments, 1), new po("arrayUnion", t);
        }.apply(void 0, t);
        ...
        var r = function() {
            ...
            // NOTE: We don't actually parse the data until it's used in set() or
            // update() since we'd need the Firestore instance to do this.
                        return L("arrayRemove()", arguments, 1), new vo("arrayRemove", t);
        }.apply(void 0, t);
    ...
    Transaction: Wo,
    WriteBatch: Yo,
    DocumentReference: Ho,
    DocumentSnapshot: Ko,
    Query: is,
    QueryDocumentSnapshot: Xo,
    QuerySnapshot: os,
    CollectionReference: ss,
    FieldPath: uo,
    FieldValue: ps,
    setLogLevel: Qo.setLogLevel,
    CACHE_SIZE_UNLIMITED: Go
};
...
function vs(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new o.Component("firestore", (function(t) {
            return function(t, e) {
                return new Qo(t, e, new ro, new io);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, ds)));
    }(t), t.registerVersion("@firebase/firestore", "1.17.2");
}

vs(u.default), exports.__PRIVATE_registerFirestore = vs;
